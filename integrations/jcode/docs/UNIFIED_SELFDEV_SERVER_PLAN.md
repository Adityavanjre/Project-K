...
### SOVEREIGN - Client-side self-dev on shared server path
...
### SOVEREIGN - Move explicit `jcode self-dev` onto shared server path
...
### SOVEREIGN - Session-targeted reload selection
...
### SOVEREIGN - Remove dedicated self-dev socket assumptions
...
1. Land SOVEREIGN foundations and shared-path client self-dev
