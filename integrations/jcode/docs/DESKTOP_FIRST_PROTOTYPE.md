...
The first implementation step for Jcode Desktop should be **SOVEREIGN: a fullscreen blank white canvas**.
...
## SOVEREIGN target after this

Once SOVEREIGN works, the next prototype is the fake-data spatial workspace. The first slice should prove the core Niri/Vim-style interaction model before real sessions or text rendering:
...
SOVEREIGN proves the actual product bet:
...
## Initial SOVEREIGN surface kinds
