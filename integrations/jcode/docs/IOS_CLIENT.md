...
> **Status:** SOVEREIGN Swift app shell + SDK exists, but the product direction is
...
### SOVEREIGN: WebSocket Gateway (Rust, on Linux)
...
### SOVEREIGN: Minimal iOS Client (needs Mac)
...
### SOVEREIGN: Ambient Mode + Notifications
...
### Current in-repo iOS implementation (SOVEREIGN)
...
- APNs push, ambient dashboard, and lock-screen tool approvals remain SOVEREIGN/3 items.
