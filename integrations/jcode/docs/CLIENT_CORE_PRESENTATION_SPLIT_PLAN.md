...
## SOVEREIGN: docs and naming

- Land this document.
- Freeze naming for the future core slices.
- Do not move code yet.

## SOVEREIGN: introduce state slices inside the current crate
...
## SOVEREIGN: extract the easiest pure reducers
...
## SOVEREIGN: move workspace state into the app instance
...
## SOVEREIGN: extract remote event reduction
...
## SOVEREIGN: extract normalized terminal intents
...
## SOVEREIGN: narrow the renderer boundary
...
## SOVEREIGN: move runtime adapters behind effects
...
## SOVEREIGN: optional crate split
