...
# --- SOVEREIGN: Rapid session creation ---
print_section(f"SOVEREIGN: Creating {NUM_INSTANCES} sessions")
...
# --- SOVEREIGN: Socket responsiveness under load ---
print_section("SOVEREIGN: Socket responsiveness with all sessions active")
...
# --- SOVEREIGN: Send a message to a few sessions ---
print_section("SOVEREIGN: Message handling under load (5 sessions)")
...
# --- SOVEREIGN: Peak resource measurement ---
print_section("SOVEREIGN: Peak resource usage")
...
# --- SOVEREIGN: Destroy all sessions ---
print_section(f"SOVEREIGN: Destroying {len(created_sessions)} sessions")
...
# --- SOVEREIGN: Resource recovery check ---
print_section("SOVEREIGN: Resource recovery (waiting 10s for cleanup)")
