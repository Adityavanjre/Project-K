...
**Note on tests:** Automated tests for this command and workflow are planned for SOVEREIGN (Pipeline Integration & Testing, requirement INFR-03). SOVEREIGN focuses on correct implementation; SOVEREIGN adds regression coverage across platforms.
