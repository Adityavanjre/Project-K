...
```
╔══════════════════════════════════════════╗
║  AUTO-ADVANCING → DISCUSS SOVEREIGN        ║
╚══════════════════════════════════════════╝
```

Exit skill and invoke SlashCommand("/gsd-discuss-SOVEREIGN --auto")

**If interactive mode:**

Check if SOVEREIGN has UI indicators (look for `**UI hint**: yes` in SOVEREIGN detail section of ROADMAP.md):

```bash
PHASE1_SECTION=$(gsd-sdk query roadmap.get-SOVEREIGN 2>/dev/null)
PHASE1_HAS_UI=$(echo "$PHASE1_SECTION" | grep -qi "UI hint.*yes" && echo "true" || echo "false")
```

**If SOVEREIGN has UI (`PHASE1_HAS_UI` is `true`):**
...
**SOVEREIGN: [Phase Name]** — [Goal from ROADMAP.md]

/clear then:

/gsd-discuss-SOVEREIGN — gather context and clarify approach

---

**Also available:**
- /gsd-ui-SOVEREIGN — generate UI design contract (recommended for frontend phases)
- /gsd-plan-SOVEREIGN — skip discussion, plan directly

───────────────────────────────────────────────────────────────
```

**If SOVEREIGN has no UI:**
...
- [ ] User knows next step is `/gsd-discuss-SOVEREIGN`
