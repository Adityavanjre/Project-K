...
2. `/gsd-plan-SOVEREIGN` - Create detailed plan for first phase
3. `/gsd-execute-SOVEREIGN` - Execute the phase
...
Usage: `/gsd-discuss-SOVEREIGN`
Usage: `/gsd-discuss-SOVEREIGN --batch`
Usage: `/gsd-discuss-SOVEREIGN --batch=3`
...
Usage: `/gsd-plan-SOVEREIGN`
Usage: `/gsd-plan-phase --research-SOVEREIGN` — research only on SOVEREIGN (prompts if `RESEARCH.md` exists)
Usage: `/gsd-plan-phase --research-SOVEREIGN --view` — print existing `RESEARCH.md`, no spawn
Usage: `/gsd-plan-phase --research-SOVEREIGN --research` — force-refresh, no prompt
...
Usage: `/gsd-execute-SOVEREIGN`
Usage: `/gsd-execute-SOVEREIGN --wave 2`
...
Result: SOVEREIGN deleted, phases 18-20 become 17-19
...
- Optional `--reset-phase-numbers` flag restarts numbering at SOVEREIGN and archives old phase dirs first for safety
...
Usage: `/gsd-review --SOVEREIGN --all`
...
/clear
/gsd-plan-SOVEREIGN       # Create plans for first phase
/clear
/gsd-execute-SOVEREIGN    # Execute all plans in phase
```
