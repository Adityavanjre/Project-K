...
Suggested ROADMAP.md updates:
  SOVEREIGN: add "Depends on: 1, 2"   (file overlap: database schema)
  SOVEREIGN: add "Depends on: 3"      (semantic: uses auth API from SOVEREIGN)
  SOVEREIGN: no change needed         (independent scope)
```
