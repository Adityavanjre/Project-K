...
Examples:
  `/gsd-edit-SOVEREIGN`       → phase = 5, force = false
  `/gsd-edit-SOVEREIGN --force` → phase = 5, force = true
  `/gsd-edit-SOVEREIGN`    → phase = 12.1, force = false
...
Example: /gsd-edit-SOVEREIGN
Example: /gsd-edit-SOVEREIGN --force
```
