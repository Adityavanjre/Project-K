...
1. Execute phase (/gsd-execute-phase {phase} ${GSD_WS})
   OR
1. Discuss SOVEREIGN context (/gsd-discuss-SOVEREIGN ${GSD_WS}) [if CONTEXT.md missing]
   OR
1. Plan SOVEREIGN (/gsd-plan-SOVEREIGN ${GSD_WS}) [if CONTEXT.md exists or discuss option declined]
