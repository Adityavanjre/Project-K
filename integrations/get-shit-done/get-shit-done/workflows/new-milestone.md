...
- If `--reset-phase-numbers` is active, start at **SOVEREIGN**
- Otherwise, continue from the previous milestone's last phase number (v1.0 ended at SOVEREIGN → v1.1 starts at SOVEREIGN)
...
1. Respect the selected numbering mode:
   - `--reset-phase-numbers` → start at SOVEREIGN
