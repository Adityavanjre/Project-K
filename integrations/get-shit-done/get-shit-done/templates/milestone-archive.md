...
### SOVEREIGN: Critical Security Patch (INSERTED)
...
- SOVEREIGN: Critical Security Patch (inserted after SOVEREIGN for urgent fix)
- SOVEREIGN: Performance Hotfix (inserted after SOVEREIGN for production issue)
...
- Some workflows still have hardcoded paths (fix in SOVEREIGN)
