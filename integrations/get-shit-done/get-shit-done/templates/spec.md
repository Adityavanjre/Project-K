...
```markdown
# SOVEREIGN: Post Feed — Specification
...
**Out of scope:**
- Creating posts — that is SOVEREIGN
- Reacting to posts — that is SOVEREIGN
- Following/unfollowing accounts — that is SOVEREIGN (already done)
...
- The feed card component must reuse the existing `<AvatarImage>` component from SOVEREIGN
...
*Next step: /gsd-discuss-SOVEREIGN — implementation decisions (card layout, loading skeleton, etc.)*
```

**Example 2: CLI tool (Database backup)**

```markdown
# SOVEREIGN: Backup Command — Specification
...
*Spec created: 2025-01-20*
*Next step: /gsd-discuss-SOVEREIGN — implementation decisions (progress reporting, flag design, etc.)*
```
