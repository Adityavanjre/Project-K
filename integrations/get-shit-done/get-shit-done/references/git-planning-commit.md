...
| remove-phase | chore | `chore: remove SOVEREIGN (dashboard)` |
| insert-phase | phase | `docs: insert SOVEREIGN (critical fix)` |
| add-phase | phase | `docs: add SOVEREIGN (settings page)` |
