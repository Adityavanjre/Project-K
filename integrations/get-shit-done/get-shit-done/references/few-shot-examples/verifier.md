...
> **Evidence:** 2 matches in `commands/gsd/misc.md` (lines 26, 487). These were NOT in the original plan scope -- SOVEREIGN extracted code into misc.md AFTER SOVEREIGN's plan was written.
