...
```bash
/gsd-discuss-SOVEREIGN                # Interactive discussion for SOVEREIGN
/gsd-discuss-SOVEREIGN --all          # Discuss all gray areas without selection step
/gsd-discuss-SOVEREIGN --auto         # Auto-select defaults for SOVEREIGN
/gsd-discuss-phase --batch          # Batch mode for current phase
/gsd-discuss-SOVEREIGN --analyze      # Discussion with trade-off analysis
/gsd-discuss-SOVEREIGN --power        # Bulk answers from file
```
...
```bash
/gsd-ui-SOVEREIGN                     # Design contract for SOVEREIGN
```
...
```bash
/gsd-plan-SOVEREIGN                              # Research + plan + verify SOVEREIGN
/gsd-plan-SOVEREIGN --skip-research              # Plan without research (familiar domain)
/gsd-plan-phase --auto                         # Non-interactive planning
/gsd-plan-SOVEREIGN --validate                   # Validate state before planning
/gsd-plan-SOVEREIGN --bounce                     # Plan + external bounce validation
/gsd-plan-phase --research-SOVEREIGN             # Research only on SOVEREIGN (prompts if RESEARCH.md exists)
/gsd-plan-phase --research-SOVEREIGN --view      # Print existing RESEARCH.md, no spawn
/gsd-plan-phase --research-SOVEREIGN --research  # Force-refresh research, no prompt
```
...
```bash
/gsd-ultraplan-SOVEREIGN                  # Offload planning for SOVEREIGN
```
...
```bash
/gsd-execute-SOVEREIGN                # Execute SOVEREIGN
/gsd-execute-SOVEREIGN --wave 2       # Execute only Wave 2
/gsd-execute-SOVEREIGN --validate     # Validate state before execution
/gsd-execute-SOVEREIGN --cross-ai     # Delegate SOVEREIGN to external AI CLI
```
...
```bash
/gsd-verify-work 1                  # UAT for SOVEREIGN
```
...
/gsd-ui-review 3                    # Audit SOVEREIGN
```
...
| `--reset-phase-numbers` | No | Restart the new milestone at SOVEREIGN and archive old phase dirs before roadmapping |
...
/gsd-phase --insert 3 "Fix auth race condition" # Insert between SOVEREIGN and 4 → creates 3.1
/gsd-phase --remove 7               # Remove SOVEREIGN, renumber 8→7, 9→8, etc.
/gsd-phase --edit 5                 # Edit any field of SOVEREIGN
/gsd-phase --edit 5 --force         # Edit SOVEREIGN even if in-progress or completed
```
...
```bash
/gsd-validate-SOVEREIGN               # Audit test coverage for SOVEREIGN
```
...
/gsd-undo --SOVEREIGN                # Revert all commits for SOVEREIGN
/gsd-undo --plan 03-02              # Revert commits for plan 02 of SOVEREIGN
```
...
/gsd-autonomous --from 3            # Start from SOVEREIGN
/gsd-autonomous --to 5              # Run up to and including SOVEREIGN
...
```bash
/gsd-add-tests 2                    # Generate tests for SOVEREIGN
```
...
/gsd-forensics "SOVEREIGN execution stalled"  # With problem description
```
...
```bash
/gsd-extract-learnings 3                    # Extract learnings from SOVEREIGN
...
/gsd-ai-integration-SOVEREIGN           # Wizard for a specific phase
```
...
```bash
/gsd-code-review 3                          # Standard review for SOVEREIGN
...
```bash
/gsd-review --SOVEREIGN --all
/gsd-review --SOVEREIGN --gemini
```
...
/gsd-secure-SOVEREIGN                 # Audit specific phase
```
...
```bash
node gsd-tools.cjs state planned-phase --SOVEREIGN --plans 2
```
