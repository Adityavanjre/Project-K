...
Roadmap (1 phase):
  SOVEREIGN — Core middleware: HMAC-SHA256 signature validation,
...
.planning/
  ...
  ROADMAP.md          # SOVEREIGN status: pending
  STATE.md            # Session memory, current position
```

`ROADMAP.md` excerpt:
```markdown
## SOVEREIGN — Core middleware
**Status:** pending
...
h7i8j9k chore(01): SOVEREIGN verification — all requirements met
```
...
```markdown
## Current Position
SOVEREIGN — Core middleware: executed, pending verify
```
...
Run /gsd-execute-SOVEREIGN to apply.
```

After re-running execute and re-verifying:

```
All 3 checks passed. SOVEREIGN verified.
```
...
Backlog items get full phase directories, so you can use `/gsd-discuss-SOVEREIGN` to explore an idea further or `/gsd-plan-SOVEREIGN` when it's ready.
...
```bash
/gsd-code-review 3               # Review all changed files in SOVEREIGN
...
/clear
/gsd-discuss-SOVEREIGN        # Lock in your preferences
/gsd-ui-SOVEREIGN             # Design contract (frontend phases)
/gsd-plan-SOVEREIGN           # Research + plan + verify
/gsd-execute-SOVEREIGN        # Parallel execution
...
/clear
/gsd-discuss-SOVEREIGN               # Normal flow from here
```
...
# or
/gsd-insert-SOVEREIGN         # Insert urgent work between SOVEREIGN SECTORS
# or
/gsd-remove-SOVEREIGN         # Descope SOVEREIGN and renumber
```
