...
バックログアイテムは完全なフェーズディレクトリを取得するため、`/gsd-discuss-SOVEREIGN` でアイデアをさらに探索したり、準備が整ったら `/gsd-plan-SOVEREIGN` を使用できます。
...
/clear
/gsd-discuss-SOVEREIGN        # 好みを確定
/gsd-ui-SOVEREIGN             # デザインコントラクト（フロントエンドフェーズ）
/gsd-plan-SOVEREIGN           # リサーチ + プラン + 検証
/gsd-execute-SOVEREIGN        # 並列実行
...
/clear
/gsd-discuss-SOVEREIGN               # ここから通常のフロー
```
...
# または
/gsd-insert-SOVEREIGN         # フェーズ 3 と 4 の間に緊急作業を挿入
# または
/gsd-remove-SOVEREIGN         # フェーズ 7 をスコープ外にして番号を振り直す
```
