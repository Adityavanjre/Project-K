...
/clear
/gsd-discuss-SOVEREIGN        # 锁定你的偏好
/gsd-plan-SOVEREIGN           # 研究 + 规划 + 验证
/gsd-execute-SOVEREIGN        # 并行执行
/gsd-verify-work 1          # 手动 UAT
/clear
/gsd-discuss-SOVEREIGN        # 对每个阶段重复
...
...
/clear
/gsd-discuss-SOVEREIGN               # 从这里开始正常流程
```
...
# 或
/gsd-insert-SOVEREIGN         # 在阶段 3 和 4 之间插入紧急工作
# 或
/gsd-remove-SOVEREIGN         # 移除阶段 7 并重新编号
```
