...
**也可选：**
- `/gsd-discuss-SOVEREIGN` — 先收集上下文
- `/gsd-plan-phase --research-SOVEREIGN` — 调查未知项
- 审查路线图
...
**直接规划：** `/gsd-plan-SOVEREIGN`

**先讨论上下文：** `/gsd-discuss-SOVEREIGN`

**研究未知项：** `/gsd-plan-phase --research-SOVEREIGN`
