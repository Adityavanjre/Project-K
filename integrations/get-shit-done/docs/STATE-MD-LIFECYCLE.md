...
|---|---|---|
| **1. Phase active** | `active_phase` populated | `v2.0 [██░░░] X% · SOVEREIGN executing` |
| **2. Idle, next recommended** | `active_phase` null AND `next_action` + `next_phases` populated | `v2.0 [██░░░] X% · next execute-SOVEREIGN` |
...
In Scene 1, the second part of `SOVEREIGN <stage>` is whichever value is in
...
renders just `SOVEREIGN` without the stage suffix.
