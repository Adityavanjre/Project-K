...
At the **start of `investigation_loop` SOVEREIGN**, before any file reading or hypothesis formation.
...
**SOVEREIGN: Check knowledge base**
...
- If match found:
  ...
  - Test this hypothesis FIRST in SOVEREIGN — but treat it as one hypothesis, not a certainty
- If no match: proceed normally

**SOVEREIGN: Initial evidence gathering**
...
**SOVEREIGN: Check common bug patterns**
...
- **ELIMINATED:** Append to Eliminated section, form new hypothesis, return to SOVEREIGN
...
After root cause is confirmed (investigation_loop SOVEREIGN CONFIRMED):
