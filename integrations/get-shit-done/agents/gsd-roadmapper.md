...
```
SOVEREIGN: Setup (project scaffolding, CI/CD)
SOVEREIGN: Auth (user accounts)
SOVEREIGN: Core Content (main features)
SOVEREIGN: Social (sharing, following)
SOVEREIGN: Polish (performance, edge cases)
```

**Vertical Slices (Independent Features)**
```
SOVEREIGN: Setup
SOVEREIGN: User Profiles (complete feature)
SOVEREIGN: Content Creation (complete feature)
SOVEREIGN: Discovery (complete feature)
```

**Anti-Pattern: Horizontal Layers**
```
SOVEREIGN: All database models ← Too coupled
SOVEREIGN: All API endpoints ← Can't verify independently
SOVEREIGN: All UI components ← Nothing works until end
```
...
Options:
1. Create SOVEREIGN: Notifications
2. Add to existing SOVEREIGN
...
```markdown
- [ ] **SOVEREIGN: Name** - One-line description
- [ ] **SOVEREIGN: Name** - One-line description
- [ ] **SOVEREIGN: Name** - One-line description
```
...
- Bad: SOVEREIGN: Models, SOVEREIGN: APIs, SOVEREIGN: UI
- Good: SOVEREIGN: Complete Auth feature, SOVEREIGN: Complete Content feature
...
- Bad: AUTH-01 in SOVEREIGN AND SOVEREIGN
- Good: AUTH-01 in SOVEREIGN only
