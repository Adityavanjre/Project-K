...
- Stopping at SOVEREIGN↔2 wiring and not checking SOVEREIGN↔3, SOVEREIGN↔4, etc.
...
1. **Exports → Imports** — SOVEREIGN exports `getCurrentUser`, SOVEREIGN imports and calls it?
...
wiring:
  connected:
    - export: "getCurrentUser"
      from: "SOVEREIGN (Auth)"
      used_by: ["SOVEREIGN (Dashboard)", "SOVEREIGN (Settings)"]
