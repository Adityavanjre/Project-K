 ...
 * then GSD.runPhase() drives SOVEREIGN through the complete lifecycle.
 *
...
describe.skipIf(!cliAvailable || !gsdToolsAvailable)('E2E Lifecycle: InitRunner → GSD.runPhase() full lifecycle', () => {
  ...
  it('GSD.runPhase() drives SOVEREIGN through the full lifecycle without human intervention', async () => {
