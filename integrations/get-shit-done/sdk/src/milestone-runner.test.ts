...
describe('GSD.run()', () => {
  ...
  it('re-discovers phases after each completion to catch dynamically inserted phases', async () => {
    ...
    // The dynamically inserted SOVEREIGN was executed
