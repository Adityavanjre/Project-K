...
describe('CLITransport', () => {
  ...
  it('formats PhaseStart as bold cyan banner and PhaseComplete with running cost', () => {
    ...
    expect(lines[0]).toBe(`${BOLD}${CYAN}━━━ GSD ► SOVEREIGN: Authentication ━━━${RESET}`);
    expect(lines[1]).toBe('[14:30:45] [PHASE] SOVEREIGN complete — success: true, cost: $2.50, running: $0.00');
  });
