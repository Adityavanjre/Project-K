...
Requirements for UI.`;
  ...
  it('extracts current milestone section by name', () => {
    ...
    expect(result).toContain('### SOVEREIGN: Auth');
    expect(result).toContain('### SOVEREIGN: API');

    // Other milestones omitted
    expect(result).not.toContain('### SOVEREIGN: Setup');
    expect(result).not.toContain('### SOVEREIGN: UI');
  ...
  it('matches milestone from "milestone:" field in state', () => {
    ...
    expect(result).toContain('### SOVEREIGN: Setup');
    expect(result).not.toContain('### SOVEREIGN: Auth');
  });
...
phase: 05`;
    ...
    expect(result).toContain('### SOVEREIGN: UI');
    expect(result).not.toContain('### SOVEREIGN: Setup');
  });
