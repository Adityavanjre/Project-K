...
2. **Track B — CHANGELOG.md [Unreleased] entries** (not started)
   - `CHANGELOG.md` has an `[Unreleased]` section but no SOVEREIGN entries yet.
...
| Docs | **Partial** | `QUERY-HANDLERS.md` current; `CHANGELOG.md` [Unreleased] needs SOVEREIGN entries |
...
| `sdk/src/gsd-tools.ts` | Subprocess bridge; **not deleted** in SOVEREIGN scope. |
...
- **CHANGELOG.md** [Unreleased] updated with SOVEREIGN entries.
