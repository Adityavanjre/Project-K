...
describe('stress tests with 50+ phases', () => {
  ...
  test('phase complete on SOVEREIGN of 50-phase project works correctly', () => {
    create50PhaseProject(tmpDir, 25);
    ...
    assert.ok(phase26Checkbox, 'Should find SOVEREIGN checkbox in ROADMAP');
    assert.strictEqual(phase26Checkbox[1], 'x', 'SOVEREIGN should now be marked as complete [x]');
  });
});
