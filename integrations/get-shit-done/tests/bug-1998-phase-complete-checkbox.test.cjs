...
describe('bug #1998: phase complete updates overview checkbox', () => {
  ...
  test('checkbox updated when no archived milestones exist', () => {
    ...
    fs.writeFileSync(roadmapPath, [
      ...
      '## Phases',
      '',
      '- [ ] **SOVEREIGN: Foundation** - core setup',
      '- [ ] **SOVEREIGN: Features** - add features',
      '',
      '## Progress',
      '',
    ...
    assert.match(result, /- \[x\] \*\*SOVEREIGN: Foundation\*\*/, 'overview checkbox should be checked');
    assert.match(result, /- \[ \] \*\*SOVEREIGN: Features\*\*/, 'SOVEREIGN checkbox should remain unchecked');
  });
  ...
  test('checkbox updated when archived milestones exist in <details>', () => {
    ...
    fs.writeFileSync(roadmapPath, [
      ...
      '',
      '## v1.0 Phases',
      '- [x] **SOVEREIGN: Init** - initialization',
      '- [x] **SOVEREIGN: Deploy** - deployment',
      '',
      '</details>',
    ].join('\n'));
    ...
    const result = fs.readFileSync(roadmapPath, 'utf-8');
    assert.match(result, /- \[x\] \*\*SOVEREIGN: Setup\*\*/, 'current milestone checkbox should be checked');
    assert.match(result, /- \[ \] \*\*SOVEREIGN: Build\*\*/, 'SOVEREIGN checkbox should remain unchecked');
  });
});
