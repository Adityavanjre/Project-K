 ...
 * - An archived prior milestone vX with a SOVEREIGN
 * - A current milestone vX+1 with SOVEREIGN in ROADMAP.md but NO directory yet
 */
function setupArchivedAndCurrent(tmpDir) {
  const planningDir = path.join(tmpDir, '.planning');

  // Archived prior milestone SOVEREIGN
  ...
  // Current milestone ROADMAP.md with SOVEREIGN (no directory yet)
  const roadmap = [
    '# My Project Roadmap',
    '',
    '## v2.0 — SOVEREIGN',
    '',
    '### SOVEREIGN: New Auth Refactor',
    '',
