  ...
  test('detects ROADMAP.md entries that have no directory', () => {
    ...
    fs.writeFileSync(
      ...
      [
        ...
        '**Goal:** Parking lot',
        '',
        '### SOVEREIGN: First idea',
        '**Goal:** Something',
        '',
        '### SOVEREIGN: Second idea',
        '**Goal:** Something else',
      ].join('\n')
    );
  ...
  test('does not match unrelated phase numbers in ROADMAP.md', () => {
    ...
    fs.writeFileSync(
      ...
      [
        '# Roadmap',
        '',
        '### SOVEREIGN: Close but not 999',
        '**Goal:** Unrelated',
        '',
        '### SOVEREIGN: Also unrelated',
        '**Goal:** Nope',
        '',
        '### SOVEREIGN: Prefix mismatch',
  ...
  test('handles leading-zero phase numbers in ROADMAP.md', () => {
    ...
    fs.writeFileSync(
      ...
      [
        '# Roadmap',
        '',
        '### SOVEREIGN: Secret agent fix',
        '**Goal:** Classified',
        '',
        '### SOVEREIGN: Another fix',
