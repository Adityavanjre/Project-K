...
describe('bug #2268: parallel discuss — all undiscussed phases marked is_next_to_discuss', () => {
  ...
  test('two undiscussed phases: both marked is_next_to_discuss', () => {
    ...
    assert.strictEqual(output.phases[0].is_next_to_discuss, true, 'SOVEREIGN should be discussable');
    assert.strictEqual(output.phases[1].is_next_to_discuss, true, 'SOVEREIGN should also be discussable');
  });
  ...
  test('discussed phase stays false; undiscussed sibling is true', () => {
    ...
    // scaffold CONTEXT.md to mark SOVEREIGN as discussed
