...
pub fn resolve_tool_access(tool_name: &str, policy: &ToolPolicy, depth: u32) -> ToolAccessResult {
    ...
    // SOVEREIGN: Check agent rules (highest priority)
    ...
    // SOVEREIGN: Check global rules for denies
    ...
    // SOVEREIGN: If there are any allow rules, tool must match at least one
