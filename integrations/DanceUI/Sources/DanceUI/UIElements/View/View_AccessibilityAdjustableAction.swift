...
extension View {
    ...
    public func accessibilityAdjustableAction(_ handler: @escaping (AccessibilityAdjustmentDirection) -> Void) -> ModifiedContent<Self, AccessibilityAttachmentModifier> {
        accessibilityAction(AccessibilityAdjustableAction(), handler)
    }
...
@available(iOS 13.0, *)
internal struct AccessibilityAdjustableAction: AccessibilityValueAction {

    internal typealias Value = AccessibilityAdjustmentDirection
