...
@available(iOS 13.0, *)
internal struct SpacingLayout: ViewModifier, Animatable, UnaryLayout {
    ...
    internal func placement(of child: LayoutProxy, in context: PlacementContext) -> _Placement {
        ...
        return _Placement(proposedSize: context.size, anchor: .init(x: 0.5, y: 0.5), at: .init(x: width * 0.5, y: height * 0.5))
    }
