...
/// DanceUI sizes a stack that doesn't contain a spacer up to the combined
...
@available(iOS 13.0, *)
internal struct _HSpacer: PrimitiveSpacer, PrimitiveView, UnaryView {

    internal var minWidth: CGFloat?
    
    internal var minLength: CGFloat? { //BDCOV_EXCL_BLOCK 没有调用点
...
@available(iOS 13.0, *)
internal struct _VSpacer: PrimitiveSpacer, PrimitiveView, UnaryView {
