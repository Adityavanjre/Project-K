...
@available(iOS 13.0, *)
internal struct SystemScrollViewAccessibilityModifier: AccessibilityViewModifier {

    internal var scrollView: HostingScrollView
    
    internal func attachment(for nodes: [AccessibilityNode]) -> AccessibilityAttachment? {
        .platform(nil, scrollView, AccessibilityAttachment.ExternalPlatformProperties())
    }
