...
@frozen
@available(iOS 13.0, *)
public struct AnyLayout : Layout, Animatable {
    ...
    public init<L>(_ layout: L) where L : Layout {
        self.storage = _AnyLayoutBox(layout: layout)
    }
    ...
    ///
    /// See ``AnyLayout/makeCache(subviews:)`` for more information.
    public struct Cache {
    ...
    /// ``explicitAlignment(of:in:proposal:subviews:cache:)-7eh5j``.
    ...
    /// calls the ``AnyLayout/updateCache(_:subviews:)`` method so you can
    ...
    public func makeCache(subviews: AnyLayout.Subviews) -> Cache {
    ...
    /// ``makeCache(subviews:)`` method, DanceUI calls the update method
    ...
    ///     collection to get information about the subviews as you
    ///     calculate values to store in the cache.
    public func updateCache(_ cache: inout Cache, subviews: AnyLayout.Subviews) {
    ...
    /// implementation, namely ``Layout/spacing(subviews:cache:)-leu1``,
    ...
    public func spacing(subviews: AnyLayout.Subviews, cache: inout Cache) -> ViewSpacing {
    ...
    public func sizeThatFits(proposal: ProposedViewSize, subviews: AnyLayout.Subviews, cache: inout Cache) -> CGSize {
    ...
    ///     the methods of your custom layout container. See
    ///     ``makeCache(subviews:)`` for details.
    public func placeSubviews(in bounds: CGRect, proposal: ProposedViewSize, subviews: AnyLayout.Subviews, cache: inout Cache) {
    ...
    ///   value.
    public func explicitAlignment(of guide: HorizontalAlignment, in bounds: CGRect, proposal: ProposedViewSize, subviews: AnyLayout.Subviews, cache: inout Cache) -> CGFloat? {
