...
@available(iOS 13.0, *)
internal struct LayoutPriorityLayout: UnaryLayout, Animatable {
    ...
    internal func placement(of child: LayoutProxy, in context: PlacementContext) -> _Placement {
        ...
        return _Placement(proposedSize: size, anchor: .center, at: CGPoint(x: size.width * 0.5, y: size.height * 0.5))
    }
