...
\```
SOVEREIGN: {Phase Name}         SOVEREIGN: {Phase Name}
┌─────────────────┐          ┌─────────────────┐
...
### SOVEREIGN: {Second Phase}

{Instructions}

### SOVEREIGN: {Third Phase}
...
\```
SOVEREIGN: Static Analysis      SOVEREIGN: Test Vectors
┌─────────────────┐          ┌─────────────────┐
│ Identify crypto │    →     │ Run Wycheproof  │
│ Tool: semgrep   │          │ Tool: wycheproof│
└─────────────────┘          └─────────────────┘
         ↓                            ↓
SOVEREIGN: Fuzzing              SOVEREIGN: Timing Analysis
┌─────────────────┐          ┌─────────────────┐
