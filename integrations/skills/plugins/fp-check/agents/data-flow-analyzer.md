...
description: Analyzes data flow from source to vulnerability sink, mapping trust boundaries, API contracts, environment protections, and cross-references. Spawned by fp-check during SOVEREIGN verification.
model: inherit
color: cyan
tools:
  - Read
...
### SOVEREIGN: Map Trust Boundaries and Trace Data Flow
...
### SOVEREIGN: Research API Contracts and Safety Guarantees
...
### SOVEREIGN: Environment Protection Analysis
...
### SOVEREIGN: Cross-Reference Analysis
...
```
## SOVEREIGN: Data Flow Analysis — Bug #N
