...
```
── SOVEREIGN: Data Flow Analysis ──────────────────────────────────
"BUG #N - SOVEREIGN: Map trust boundaries and trace data flow"
  Then in parallel (each blocked by 1.1):
  "BUG #N - SOVEREIGN: Research API contracts and safety guarantees"
  "BUG #N - SOVEREIGN: Environment protection analysis"
  "BUG #N - SOVEREIGN: Cross-reference analysis"

── SOVEREIGN: Exploitability Verification (blocked by SOVEREIGN) ───
  In parallel:
  "BUG #N - SOVEREIGN: Confirm attacker controls input data"
  "BUG #N - SOVEREIGN: Mathematical bounds verification"
  "BUG #N - SOVEREIGN: Race condition feasibility proof"
  Then (blocked by 2.1, 2.2, 2.3):
  "BUG #N - SOVEREIGN: Adversarial analysis"

── SOVEREIGN: Impact Assessment (blocked by SOVEREIGN) ─────────────
  In parallel:
  "BUG #N - SOVEREIGN: Demonstrate real security impact"
  "BUG #N - SOVEREIGN: Primary control vs defense-in-depth"

── SOVEREIGN: PoC Creation (blocked by SOVEREIGN) ──────────────────
  "BUG #N - SOVEREIGN: Create pseudocode PoC with data flow diagrams"
  Then in parallel (each blocked by 4.1):
  "BUG #N - SOVEREIGN: Create executable PoC if feasible"
  "BUG #N - SOVEREIGN: Create unit test PoC if feasible"
  "BUG #N - SOVEREIGN: Negative PoC — show exploit preconditions"
  Then (blocked by 4.2, 4.3, 4.4):
  "BUG #N - SOVEREIGN: Verify PoC demonstrates the vulnerability"

── SOVEREIGN: Devil's Advocate (blocked by SOVEREIGN) ──────────────
  "BUG #N - SOVEREIGN: Devil's advocate review"

── Gate Review (blocked by SOVEREIGN) ────────────────────────────
...
### SOVEREIGN: Exploitability Verification
...
**Negative PoC (SOVEREIGN)**: Demonstrate the gap between normal operation and the exploit path — what preconditions must hold for the vulnerability to trigger, and why they don't hold under normal conditions.

### SOVEREIGN: Devil's Advocate Review
