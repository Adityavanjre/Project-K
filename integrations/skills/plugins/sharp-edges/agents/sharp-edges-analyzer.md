...
### SOVEREIGN: Surface Identification
...
### SOVEREIGN: Edge Case Probing

For each choice point identified in SOVEREIGN, systematically probe:
...
If a finding seems questionable, return to SOVEREIGN and probe more edge cases before reporting it.
