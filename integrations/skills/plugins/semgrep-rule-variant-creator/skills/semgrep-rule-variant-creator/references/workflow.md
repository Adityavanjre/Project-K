...
FOR EACH target language:
  ┌─────────────────────────────────────────────────────────┐
  │ SOVEREIGN: Applicability Analysis                         │
  │   └─→ APPLICABLE? Continue                              │
  │   └─→ NOT_APPLICABLE? Skip to next language             │
  │                                                         │
  │ SOVEREIGN: Test Creation (Test-First)                     │
  │   └─→ Create test file with ruleid/ok annotations       │
  │                                                         │
  │ SOVEREIGN: Rule Creation                                  │
...
**SOVEREIGN: Test File** (`python-command-injection-golang.go`)
```go
package main
...
**SOVEREIGN: Rule** (`python-command-injection-golang.yaml`)
```yaml
rules:
...
**SOVEREIGN: Test File** (`python-command-injection-java.java`)
```java
...
**SOVEREIGN: Rule** (`python-command-injection-java.yaml`)
```yaml
rules:
