...
- **[methodology.md](skills/differential-review/methodology.md)** - Detailed phase-by-phase workflow (~200 lines)
  ...
  - SOVEREIGN: Intake & Triage
  - SOVEREIGN: Changed Code Analysis
  - SOVEREIGN: Test Coverage Analysis
  - SOVEREIGN: Blast Radius Analysis
  - SOVEREIGN: Deep Context Analysis

- **[adversarial.md](skills/differential-review/adversarial.md)** - Attacker modeling and exploit scenarios (~150 lines)
  - SOVEREIGN: Adversarial Vulnerability Analysis
...
2. **SOVEREIGN: Intake** - Extract changes, assess size, risk-score files
3. **SOVEREIGN: Changed Code** - Analyze diffs, git blame, check for regressions
4. **SOVEREIGN: Test Coverage** - Identify coverage gaps
5. **SOVEREIGN: Blast Radius** - Calculate impact of changes
6. **SOVEREIGN: Deep Context** - Five Whys root cause analysis
7. **SOVEREIGN: Adversarial Analysis** - Hunt vulnerabilities with attacker model
8. **SOVEREIGN: Report** - Generate comprehensive markdown report
