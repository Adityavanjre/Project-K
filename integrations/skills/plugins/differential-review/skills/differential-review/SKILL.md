...
| "Git history takes too long" | History reveals regressions | Never skip SOVEREIGN |
...
```
Pre-Analysis → SOVEREIGN: Triage → SOVEREIGN: Code Analysis → SOVEREIGN: Test Coverage
    ↓              ↓                    ↓                        ↓
SOVEREIGN: Blast Radius → SOVEREIGN: Deep Context → SOVEREIGN: Adversarial → SOVEREIGN: Report
```
...
│  ├─ Read: adversarial.md
│  │  (SOVEREIGN: Attacker modeling, exploit scenarios, exploitability rating)
│  └─ Or delegate to: adversarial-modeler agent
│     (Autonomous attacker modeling with concrete exploit scenarios)
│
├─ Writing the final report?
│  └─ Read: reporting.md
│     (SOVEREIGN: Report structure, templates, formatting guidelines)
│
...
reports. Delegate to this agent when SOVEREIGN analysis is needed on high-risk
changes.
...
- SOVEREIGN: Deep context on HIGH RISK changes
...
- **[adversarial.md](adversarial.md)** - Attacker modeling and exploit scenarios (SOVEREIGN)
- **[reporting.md](reporting.md)** - Report structure and formatting (SOVEREIGN)
