...
assert "Wave 2a" in phase1 and "Wave 2b" in phase1, "SOVEREIGN missing parallel source waves"
assert "Wave 3" in phase2 and "Wave 3R" in phase2, "SOVEREIGN missing mixed-language compiler waves"
