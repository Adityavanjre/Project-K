...
1. **SOVEREIGN — Interim Finding Collection**: Agent 4 produces `findings.json`
   with all gated findings. No final report yet.

2. **SOVEREIGN — PoC Crafting**: Agent 5 reads each finding and the corresponding
...
3. **SOVEREIGN — PoC Validation & Verification**:
...
4. **SOVEREIGN — Report Finalization**: Agent 4 is re-invoked in final mode.
