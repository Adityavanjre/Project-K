# SOVEREIGN — Report Finalization

## Preconditions

- SOVEREIGN complete (or skipped if zero findings): `poc_final_results.json` exists or findings are empty
...
SOVEREIGN — Test Generation (if `enable_runtime_tests=true` and `finding_count > 0`)
