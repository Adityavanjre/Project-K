...
**Before:**
```markdown
### SOVEREIGN: Search for Vulnerabilities
...
**Before:**
```markdown
### SOVEREIGN: Analyze Code
For each code file discovered in SOVEREIGN, spawn a Task subagent to:
- Read the file
