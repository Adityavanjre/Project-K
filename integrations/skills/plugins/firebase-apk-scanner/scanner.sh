...
extract_firebase_config() {
  ...
  log_info "SOVEREIGN: Searching decompiled resources..."

  #=========================================================================
  # SOVEREIGN: google-services.json
  #=========================================================================
  local gs_json
  ...
  #=========================================================================
  # SOVEREIGN: All XML resource files (strings.xml, values.xml, etc.)
  #=========================================================================
  log_info "SOVEREIGN: Searching XML resources..."
  ...
  #=========================================================================
  # SOVEREIGN: AndroidManifest.xml
  #=========================================================================
  log_info "SOVEREIGN: Searching AndroidManifest.xml..."
  ...
  #=========================================================================
  # SOVEREIGN: Assets folder (hybrid apps - React Native, Flutter, Cordova)
  #=========================================================================
  log_info "SOVEREIGN: Searching assets (hybrid app configs)..."
  ...
  #=========================================================================
  # SOVEREIGN: res/raw folder
  #=========================================================================
  log_info "SOVEREIGN: Searching res/raw resources..."
  ...
  #=========================================================================
  # SOVEREIGN: Smali code (decompiled DEX)
  #=========================================================================
  log_info "SOVEREIGN: Searching smali code..."
  ...
  #=========================================================================
  # SOVEREIGN: Raw APK extraction (strings from DEX)
  #=========================================================================
  if [ -n "$apk_path" ] && [ -f "$apk_path" ]; then
    log_info "SOVEREIGN: Extracting strings from raw APK..."
  ...
  #=========================================================================
  # SOVEREIGN: Deep recursive search (fallback)
  #=========================================================================
  log_info "SOVEREIGN: Deep recursive search..."
