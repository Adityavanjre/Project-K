...
│  └─ Jump to SOVEREIGN (run native diff + graph_diff.py)
│
...
- [ ] SOVEREIGN: Create snapshots (git worktrees)
- [ ] SOVEREIGN: Build graphs + pre-analysis on both snapshots
- [ ] SOVEREIGN: Compute structural diff
- [ ] SOVEREIGN: Interpret diff and generate report
- [ ] SOVEREIGN: Clean up worktrees
```

### SOVEREIGN: Create Snapshots
...
use the directory paths directly in SOVEREIGN

### SOVEREIGN: Build Graphs and Run Pre-Analysis
...
Using the same `work_dir` from SOVEREIGN:
...
error instead of continuing to SOVEREIGN
...
**trailmark skill:**
SOVEREIGN uses the trailmark API for graph building and pre-analysis.
