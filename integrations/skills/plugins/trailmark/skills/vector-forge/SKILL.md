...
```
SOVEREIGN: Discovery       → Find implementations to test
      ↓
SOVEREIGN: Harness         → Write/adapt test vector harness for each impl
      ↓
SOVEREIGN: Baseline        → Run mutation testing with existing vectors
      ↓
SOVEREIGN: Escape Analysis → Classify escaped mutants by code path
      ↓
SOVEREIGN: Vector Gen      → Create test vectors targeting escapes
      ↓
SOVEREIGN: Validation      → Re-run mutation testing, compare before/after
      ↓
...
Save the full mutation log for SOVEREIGN analysis.

---

## SOVEREIGN: Escape Analysis (Graph-Informed Triage)
...
Each group becomes a target for new test vectors in SOVEREIGN

---

## SOVEREIGN: Vector Generation
...
| Skill | Relationship |
|-------|-------------|
| **genotoxic** (required for SOVEREIGN) | Provides graph-informed triage — call graph cuts actionable mutants by 30-50% |
