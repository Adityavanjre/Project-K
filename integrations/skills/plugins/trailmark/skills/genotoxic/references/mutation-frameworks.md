...
the universal mutant record format for SOVEREIGN triage.
...
universal mutant record format for SOVEREIGN triage.
...
To normalize for SOVEREIGN, map each diff to the universal mutant record:
...
before feeding into SOVEREIGN triage:
...
Normalize each finding before feeding into SOVEREIGN triage:
