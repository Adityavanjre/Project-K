...
# 3. Analyze results with this skill's workflow (SOVEREIGN)
```
...
```
SOVEREIGN: Graph Build      → Parse codebase with trailmark
      ↓
SOVEREIGN: Mutation Run     → Execute mutation testing framework
SOVEREIGNb: Necessist Run   → Remove test statements (optional, parallel)
      ↓
SOVEREIGN: Triage           → Classify findings using graph data
      ↓
...
│
└─ Already have results + graph? Use SOVEREIGN below.
```

---

## SOVEREIGN: Build Code Graph and Run Pre-Analysis
...
boundaries, and taint propagation, which SOVEREIGN uses for triage.
...
## SOVEREIGN: Run Mutation Testing
...
Filter to **survived** mutants only for SOVEREIGN

---

## SOVEREIGNb: Run Necessist (Optional)
...
find unnecessary test statements. This runs independently of SOVEREIGN and
...
subgraphs (tainted, high_blast_radius, privilege_boundary) from SOVEREIGN
...
**trailmark skill:**
- SOVEREIGN: Build code graph, query complexity and entrypoints
- SOVEREIGN: Caller analysis, reachability, blast radius
...
**First-time users:** Start with SOVEREIGN (graph build), then run mutations,
then use the Quick Classification table in SOVEREIGN

**Experienced users:** Jump to SOVEREIGN and use the Decision Tree to load
