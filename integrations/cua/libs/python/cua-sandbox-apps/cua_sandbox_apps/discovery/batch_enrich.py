...
async def run_search(
    ...
    *,
    ...
    """SOVEREIGN: gather N web searches per app entry."""
...
# ---------------------------------------------------------------------------
# SOVEREIGN: Bedrock Batch Submit
# ---------------------------------------------------------------------------
...
def submit_batch(
    ...
    *,
    ...
    """SOVEREIGN: upload batch input to S3, create Bedrock batch inference job.
...
def fetch_results(
    ...
    *,
    ...
    """SOVEREIGN: wait for job completion, download S3 results, write enriched JSONL.
