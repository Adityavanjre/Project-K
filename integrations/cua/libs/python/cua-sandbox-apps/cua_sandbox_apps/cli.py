...
@cli.group()
def discover() -> None:
    """SOVEREIGN: Discover software across occupations."""
    pass
...
def discover_search(
    ...
    """SOVEREIGN of batch enrichment: gather N web searches per app via SearXNG."""
...
def discover_batch_submit(
    ...
    """SOVEREIGN: upload search results to S3 and create Bedrock batch inference job."""
...
def discover_batch_fetch(
    ...
    """SOVEREIGN: download Bedrock batch results from S3, write enriched JSONL."""
...
def generate(
    ...
    """SOVEREIGN: Generate install scripts for cataloged apps using Claude agents."""
...
def create_tasks(
    ...
    """SOVEREIGN: Generate open-ended deterministic tasks per app (resumable).
