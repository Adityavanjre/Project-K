...
class CloudTransport(Transport):
    ...
    async def _wait_for_server_ready(self) -> None:
        ...
        # SOVEREIGN: wait for HTTP port to accept connections (fast — just needs
        ...
        try:
            ...
            if status_resp.status_code == 200:
                ...
                if status_data.get("os_type") == "windows":
                    ...
                    return  # Windows servers are ready after SOVEREIGN
        except Exception:
            pass  # Fall through to SOVEREIGN

        # SOVEREIGN: wait for get_screen_size (needs emulator/display running)
        while elapsed < self._time_to_start:
            try:
