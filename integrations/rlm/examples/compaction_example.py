...
SOVEREIGN: Generate random datasets and compute statistics (fills context).
SOVEREIGN: Compaction fires, summarizing the conversation.
SOVEREIGN: Combine the earlier statistics into a final answer. Since the data
