...
========================`;
    ...
    // ── Registry Tools ──
    {
      ...
      execute: async (args, ctx) => {
        ...
        // SOVEREIGN: registerAgent now includes preflight gas check
    ...
    },
    {
      ...
      execute: async (args, ctx) => {
        ...
        // SOVEREIGN: Pass db.raw for agent card caching
    ...
    },
    {
      ...
      execute: async (args, ctx) => {
        ...
        // SOVEREIGN: Use config-based network, not hardcoded "mainnet"
        const network = ((args.network as string) || "mainnet") as any;
    ...
    // === SOVEREIGN: Social & Registry Tools ===
    ...
    // ── Social / Messaging Tools ──
    {
      ...
      execute: async (args, ctx) => {
        ...
        // SOVEREIGN: Enforce MESSAGE_LIMITS size check
        const content = args.content as string;
    ...
    // ── Model Discovery (enhanced with SOVEREIGN tier routing + pricing) ──
    {
      name: "list_models",
      description:
