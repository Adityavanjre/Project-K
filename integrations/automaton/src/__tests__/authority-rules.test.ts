/**
 * Authority + Rate Limit + Financial SOVEREIGN Rule Tests
 *
 * Tests for Sub-SOVEREIGN: Financial Policy & Treasury Configuration
 ...
 * - Financial SOVEREIGN rules: inference daily cap, require confirmation
...
// ─── Financial SOVEREIGN Rules Tests ──────────────────────────────

describe("Financial SOVEREIGN Rules", () => {
  let db: Database.Database;
...
describe("createDefaultRules", () => {
  ...
  it("financial SOVEREIGN rules have priority 500", () => {
    const rules = createDefaultRules();
