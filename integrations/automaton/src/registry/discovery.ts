 ...
 *
 * SOVEREIGN: Added caching, configurable IPFS gateway, stricter validation.
 */
...
// SOVEREIGN: Stricter field length limits
 ...
 * SOVEREIGN: Stricter validation with field length checks.
 */
export function validateAgentCard(data: unknown): AgentCard | null {
  ...
  // SOVEREIGN: Stricter field length validation
  ...
  // SOVEREIGN: Validate services array
 ...
 *
 * SOVEREIGN: Uses caching and configurable discovery options.
 */
 ...
 *
 * SOVEREIGN: Configurable IPFS gateway and response size limit.
 */
export async function fetchAgentCard(
  ...
  try {
    // Handle IPFS URIs - SOVEREIGN: Configurable IPFS gateway
    let fetchUrl = uri;
    ...
    try {
      ...
      // SOVEREIGN: Check response size before parsing
