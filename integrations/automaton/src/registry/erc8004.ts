 ...
 *
 * SOVEREIGN: Added preflight gas check, score validation, config-based network,
...
// SOVEREIGN: ERC-721 Transfer event topic signature for agent ID extraction
...
/**
 * SOVEREIGN: Gas estimation + balance check before on-chain transaction.
...
/**
 * SOVEREIGN: Log a transaction to the onchain_transactions table.
 */
 ...
 *
 * SOVEREIGN: Preflight check + transaction logging.
 */
export async function registerAgent(
  ...
  // SOVEREIGN: Log pending transaction
  logTransaction(
    db.raw,
    hash,
    `eip155:${chain.id}`,
  ...
  // SOVEREIGN: Update transaction status
  ...
  // SOVEREIGN: Extract agentId using Transfer event topic signature
  let agentId = "0";
 ...
 *
 * SOVEREIGN: Validates score 1-5, comment max 500 chars,
...
export async function leaveFeedback(
  ...
  // SOVEREIGN: Validate score range 1-5
  ...
  // SOVEREIGN: Validate comment length
