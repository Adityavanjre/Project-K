 ...
 *
 * SOVEREIGN: All tasks accept TickContext as first parameter.
...
export const BUILTIN_TASKS: Record<string, HeartbeatTaskFn> = {
  ...
  // === SOVEREIGN: Model Registry Refresh ===
