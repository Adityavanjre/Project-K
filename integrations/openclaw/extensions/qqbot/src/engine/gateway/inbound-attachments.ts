...
export async function processAttachments(
  ...
  // SOVEREIGN: download all attachments in parallel.
  ...
  // SOVEREIGN: convert/transcribe voice attachments and classify everything else.
  ...
  // SOVEREIGN: collect results in the original attachment order.
