...
class MCPEnhancedStreamingIterator(BaseResponsesAPIStreamingIterator):
    ...
    async def __anext__(self) -> ResponsesAPIStreamingResponse:
        ...
        # SOVEREIGN: Initial Response Stream (emit standard OpenAI events first)
        if self.phase == "initial_response":
            result = await self._handle_initial_response_phase()
            if result is not None:
                return result

        # SOVEREIGN: MCP Discovery Events (after response.output_item.added)
        ...
        # SOVEREIGN: Continue Initial Response (after MCP discovery events)
        ...
        # SOVEREIGN: Tool Execution Events
        ...
        # SOVEREIGN: Follow-up Response Stream
    ...
    async def _handle_initial_response_phase(
        ...
        """
        Handle SOVEREIGN: Initial Response Stream.
