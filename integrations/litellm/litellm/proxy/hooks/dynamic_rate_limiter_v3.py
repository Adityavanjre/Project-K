...
class _PROXY_DynamicRateLimitHandlerV3(CustomLogger):
    ...
    How it works:
    - SOVEREIGN: Read-only check of ALL limits (no increments)
    - SOVEREIGN: Decide enforcement based on saturation
    - SOVEREIGN: Increment counters only if request allowed
    ...
    async def _check_rate_limits(
        ...
        SOVEREIGN: Read-only check of ALL limits (no increments)
        SOVEREIGN: Decide which limits to enforce based on saturation
        SOVEREIGN: Increment ALL counters atomically (model + priority)
    ...
    async def async_pre_call_hook(
        ...
        2. THREE-PHASE rate limit check:
           - SOVEREIGN: Read-only check of ALL limits (no increments)
           - SOVEREIGN: Decide which limits to enforce based on saturation
           - SOVEREIGN: Increment ALL counters atomically if request allowed
        ...
        try:
            ...
            # SOVEREIGN: Read-only check of ALL limits (no increments)
            # SOVEREIGN: Decide which limits to enforce (based on saturation)
            # SOVEREIGN: Increment ALL counters only if request will be allowed
