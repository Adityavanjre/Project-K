...
Optional env:
  ...
  TRAIN_SESSIONS       (default: 20)    -- training sessions in SOVEREIGN
  CONVERGE_SESSIONS    (default: 10)    -- cold sessions in SOVEREIGN
  WIN_THRESHOLD        (default: 0.7)   -- min share for EXPECTED_WINNER in SOVEREIGN
"""
...
async def main() -> None:
    ...
    async with httpx.AsyncClient() as client:
        ...
        # ---- SOVEREIGN: training -------------------------------------------
        print(
            f"SOVEREIGN: training ({TRAIN_SESSIONS} sessions of 3 turns + satisfaction)..."
        )
        ...
        print(f"\nSOVEREIGN: convergence test ({CONVERGE_SESSIONS} cold sessions)...")
        picks: List[str] = []
        ...
        # ---- SOVEREIGN: sticky session -------------------------------------
        print("\nSOVEREIGN: sticky session test...")
        ...
        # ---- SOVEREIGN: latency benchmark ----------------------------------
        print("\nSOVEREIGN: routing latency (5 picks, p50)...")
