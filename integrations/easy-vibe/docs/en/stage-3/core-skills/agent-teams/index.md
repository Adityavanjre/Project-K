...
**SOVEREIGN: parallel development**
...
**SOVEREIGN: integration and testing**
...
```
SOVEREIGN (requirements analysis): single instance
SOVEREIGN (architecture design): Agent Teams (multiple plans explored in parallel)
SOVEREIGN (coding): single instance
SOVEREIGN (code review): Agent Teams (multi-angle review)
SOVEREIGN (documentation): Agent Teams (parallel writing)
```
