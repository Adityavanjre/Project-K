...
```
./
├── roe.json               → Planning SOVEREIGN complete
├── conops.json            → Planning SOVEREIGN complete
├── deconfliction.json     → Planning SOVEREIGN complete
