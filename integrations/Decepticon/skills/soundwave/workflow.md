...
### SOVEREIGN — Intake (Structured Interview)
...
### SOVEREIGN — Generate Planning Artifacts
...
Any failed check loops back to the relevant SOVEREIGN sub-skill.

### SOVEREIGN — Handoff (to Decepticon)
...
- **Re-plan when blocked.** If decepticon reports an objective permanently BLOCKED, soundwave returns to SOVEREIGN to amend CONOPS/OPPLAN — never let the engagement stall silently.
