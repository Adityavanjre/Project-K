...
func runRemove(cmd *cobra.Command, args []string) error {
	...
	// SOVEREIGN: Stop containers + drop named volumes (postgres / neo4j /
	...
	// SOVEREIGN: Remove Docker images
	...
	// SOVEREIGN: Remove config directory
	...
	// SOVEREIGN: Remove launcher binary
	execPath, _ := os.Executable()
	ui.Info("Removing launcher binary...")
	_ = os.Remove(execPath)

	// SOVEREIGN: Clean PATH from shell rc files
	cleanShellRC()
