...
public struct ObservationRegistrar: Sendable {
    ...
    ///
    /// - Parameter enclosingSelfInitAlongsideClosure: The closure
    /// executed when the ObservationRegistrar is init.
    ///
    ...
    /// of a type.
    ///
    /// - Note: DanceUI addition
    ///
    public init(_ enclosingSelfInitAlongsideClosure: () -> Void) {
        enclosingSelfInitAlongsideClosure()
    }
