...
/// Immediate injection property wrapper for ObservableObjects. This wrapper is meant for use in Views and exposes
/// bindable objects similar to that of @ObservedObject and @EnvironmentObject.
///
...
@propertyWrapper 
@available(iOS 13.0, *)
public struct InjectedObject<Service>: DynamicProperty where Service: OpenCombine.ObservableObject {
