...
extension CustomAnimation {
    ...
    public func shouldMerge<V: VectorArithmetic>(previous: Animation, value: V, time: TimeInterval, context: inout AnimationContext<V>) -> Bool {
        false
    }
}
...
extension Animation : Hashable {
    ...
    public func animate<V: VectorArithmetic>(value: V,
                                             time: TimeInterval,
    ...
    public func velocity<V: VectorArithmetic>(value: V,
                                              time: TimeInterval,
    ...
    public func shouldMerge<V: VectorArithmetic>(previous: Animation,
                                                 value: V,
                                                 time: TimeInterval,
