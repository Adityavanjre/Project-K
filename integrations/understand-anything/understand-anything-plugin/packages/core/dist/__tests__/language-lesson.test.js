...
import { buildLanguageLessonPrompt, parseLanguageLessonResponse, detectLanguageConcepts, } from "../analyzer/language-lesson.js";
...
describe("language-lesson", () => {
    describe("buildLanguageLessonPrompt", () => {
        ...
        it("includes the target language", () => {
            const prompt = buildLanguageLessonPrompt(sampleNode, sampleEdges, "typescript", typescriptConfig);
    ...
    describe("parseLanguageLessonResponse", () => {
        it("parses a valid response", () => {
            ...
            expect(result.languageNotes).toBe("Uses async/await for non-blocking token verification.");
...
//# sourceMappingURL=language-lesson.test.js.map
