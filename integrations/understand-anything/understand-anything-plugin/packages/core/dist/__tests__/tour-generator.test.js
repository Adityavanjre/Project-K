...
import { buildTourGenerationPrompt, parseTourGenerationResponse, generateHeuristicTour, } from "../analyzer/tour-generator.js";
const sampleGraph = {
    version: "1.0.0",
    project: {
        name: "test-project",
...
\`\`\``;
    ...
    describe("generateHeuristicTour", () => {
        ...
        it("follows topological order", () => {
            ...
            const codeSteps = tour.filter((s) => !s.title.toLowerCase().includes("concept"));
        ...
        it("includes concept nodes in separate steps", () => {
            ...
            const conceptStep = tour.find((s) => s.nodeIds.includes("concept:auth-flow"));
...
//# sourceMappingURL=tour-generator.test.js.map
