...
beforeAll(async () => {
    ...
    await Parser.init();
    const wasmPath = require.resolve("tree-sitter-ruby/tree-sitter-ruby.wasm");
...
`);
            ...
            expect(userService.properties).toEqual(expect.arrayContaining(["name", "email", "id"]));
            ...
            const standaloneHelperCalls = calls.filter((e) => e.caller === "standalone_helper");
...
//# sourceMappingURL=ruby-extractor.test.js.map
