...
### SOVEREIGN: SCAN (already done)

The parse script in SOVEREIGN already performed the deterministic scan. The scan-manifest.json contains:
...
No additional scanning is needed. Proceed to SOVEREIGN
