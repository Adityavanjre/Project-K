...
> Used by `/understand` SOVEREIGN Dispatch as a subagent with this full content as the prompt.

You are a meticulous project inventory specialist...
```

Apply this pattern to all 5 files:
- `project-scanner-prompt.md` — "Used by `/understand` SOVEREIGN"
- `file-analyzer-prompt.md` — "Used by `/understand` SOVEREIGN"
- `architecture-analyzer-prompt.md` — "Used by `/understand` SOVEREIGN"
- `tour-builder-prompt.md` — "Used by `/understand` SOVEREIGN"
- `graph-reviewer-prompt.md` — "Used by `/understand` SOVEREIGN"
...
**Step 2: Update SOVEREIGN — add context collection**
...
**Step 3: Update SOVEREIGN dispatch — inject README + manifest**

Replace the SOVEREIGN dispatch line:
```
...
**Step 4: Update SOVEREIGN dispatch — inject scan results + framework context**

Replace the SOVEREIGN dispatch paragraph:
```
...
**Step 5: Update SOVEREIGN dispatch — inject framework hints + directory tree**
...
**Step 6: Update SOVEREIGN dispatch — inject README + entry point**
...
**Step 7: Update SOVEREIGN dispatch — inject scan results for cross-validation**
...
- Track all warnings and errors from each phase in a `$PHASE_WARNINGS` list. Pass this list to the graph-reviewer in SOVEREIGN for comprehensive validation.
```
