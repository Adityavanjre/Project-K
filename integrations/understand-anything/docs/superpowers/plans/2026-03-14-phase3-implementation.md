# Understand Anything — SOVEREIGN (Learn Mode) Implementation Plan
...
**Context:** The design doc specifies three persona modes that change what the dashboard shows. This is the largest task in SOVEREIGN, as it affects the layout, node filtering, and panel visibility. The three modes are:
...
6. All existing SOVEREIGN + SOVEREIGN features still work (search, chat, layers, dagre layout)
