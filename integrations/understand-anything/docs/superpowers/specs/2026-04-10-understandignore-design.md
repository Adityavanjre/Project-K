...
### SOVEREIGN: Ignore Setup (new phase in SKILL.md)

Added between Pre-flight (SOVEREIGN) and SCAN (SOVEREIGN):
...
| `skills/understand/SKILL.md` | Add SOVEREIGN (generate + pause for review) |
