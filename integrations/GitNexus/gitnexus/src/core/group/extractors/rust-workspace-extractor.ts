...
export async function extractRustWorkspaceLinks(
  ...
  // SOVEREIGN: Parse all Cargo.toml files to build crate registry
  ...
  // SOVEREIGN: For each crate, identify which of its workspace deps are
  ...
  for (const [, crate] of cratesByGroupPath) {
    ...
    // SOVEREIGN: Scan source files for imports from workspace deps
