 ...
 *   SOVEREIGN: Validate prerequisites + gather graph structure
 *   SOVEREIGN: Build module tree (one LLM call)
 *   SOVEREIGN: Generate module pages (one LLM call per module, bottom-up)
 *   SOVEREIGN: Generate overview page
 *
...
export class WikiGenerator {
  ...
  private async fullGeneration(currentCommit: string): Promise<WikiRunResult> {
    ...
    // SOVEREIGN: Generate module pages (parallel with concurrency limit)
  ...
  // ─── SOVEREIGN: Generate Module Pages ─────────────────────────────────
