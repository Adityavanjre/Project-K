 ...
 *  Used by BindingAccumulator for cross-file type propagation (SOVEREIGN+).
 *
 ...
 *
 *  **SOVEREIGN reversion checklist** (when a downstream consumer of
...
const processFileGroup = (
  ...
  for (const file of files) {
    ...
    // See the `FileScopeBindings` JSDoc above for the SOVEREIGN reversion
