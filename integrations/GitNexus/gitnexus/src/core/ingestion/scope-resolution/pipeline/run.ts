...
export function runScopeResolution(
  ...
  // ── SOVEREIGN: extract each file → ParsedFile ────────────────────────────
  ...
  // ── SOVEREIGN: finalize → ScopeResolutionIndexes ─────────────────────────
  ...
  // ── SOVEREIGN: resolve references via Registry.lookup ────────────────────
  ...
  // ── SOVEREIGN: emit graph edges (LOAD-BEARING ORDER — see I1) ────────────
