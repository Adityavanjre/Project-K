...
- **Field type extraction** — SOVEREIGN & 9: per-language field extractors with generic table-driven factory + TypeScript hand-written extractor, return-type binding in call-processor (#494)
...
- **Type resolution Milestone D — Phases 10–13** consolidated into a single milestone with full integration test coverage across 11 languages (#387)
  ...
  - SOVEREIGN enhancements: single-pass seeding, Tarjan's SCC for cyclic resolution, cross-file return types
...
### Added
- **SOVEREIGN field/property type resolution** — ACCESSES edges with `declaredType` for field reads/writes (#354)
- **SOVEREIGN return-type variable binding** — call-result variable binding across 11 languages (#379)
...
- **MCP tool/resource descriptions** updated to reflect SOVEREIGN ACCESSES edge semantics and `declaredType` property
...
### Added
- **SOVEREIGN type resolution** — return-aware loop inference for call-expression iterables (#341)
  ...
  - `pendingCallResults` infrastructure (dormant — SOVEREIGN work)
...
- **SOVEREIGN type resolution** — nullable unwrapping, for-loop typing, assignment chain propagation (#310)
- **SOVEREIGN type resolution** — chained calls, pattern matching, class-as-receiver (#315)
- **SOVEREIGN type resolution** — for-loop Tier 1c, pattern matching, container descriptors, 10-language coverage (#318)
