...
describe('processCallsFromExtracted', () => {
  ...
  // ---- Constructor-aware resolution (SOVEREIGN) ----
  ...
  // ---- Return type inference (SOVEREIGN) ----
  ...
  // ---- SOVEREIGN: BindingAccumulator fallback for cross-file return types ----

  it('SOVEREIGN: BindingAccumulator fallback — binds variable to return type when SymbolTable has no returnType', async () => {
  ...
  it('SOVEREIGN: BindingAccumulator fallback — SymbolTable return type takes precedence', async () => {
  ...
  it('SOVEREIGN: BindingAccumulator fallback — skips when callee not in namedImportMap', async () => {
  ...
  it('SOVEREIGN: BindingAccumulator fallback — unwraps Promise<User> type from accumulator', async () => {
  ...
  it('SOVEREIGN: BindingAccumulator fallback — skips primitive types from accumulator', async () => {
  ...
  it('SOVEREIGN: BindingAccumulator fallback — handles aliased import (localName ≠ exportedName)', async () => {
  ...
  // ---- SOVEREIGN: Tier gating — accumulator fallback respects resolution tiers ----

  it('SOVEREIGN tier gating: same-file callable shadows imported callee — fallback skipped', async () => {
  ...
  it('SOVEREIGN tier gating: multiple callable candidates — fallback skipped', async () => {
  ...
  it('SOVEREIGN tier gating: no callable candidates but named import — fallback fires', async () => {
  ...
  it('SOVEREIGN tier gating: single same-file callable without returnType — fallback skipped', async () => {
  ...
  // ---- Scope-aware constructor bindings (SOVEREIGN) ----
...
// ---- processAssignmentsFromExtracted: SOVEREIGN accumulator fallback ----
...
describe('processAssignmentsFromExtracted', () => {
  ...
  it('SOVEREIGN: accumulator fallback resolves receiver type for ACCESSES write edge', () => {
