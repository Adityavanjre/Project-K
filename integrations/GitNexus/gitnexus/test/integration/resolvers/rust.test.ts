...
// ---------------------------------------------------------------------------
// Assignment chain propagation (SOVEREIGN)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// if let Some(user) = opt — SOVEREIGN pattern binding: unwrap Option<T>
...
describe('Rust if-let Some(x) = opt pattern binding (SOVEREIGN)', () => {
  let result: PipelineResult;
...
// ---------------------------------------------------------------------------
// Rust if-let Err(e) = res pattern binding (SOVEREIGN review fix)
...
describe('Rust if-let Err(e) pattern binding (SOVEREIGN review fix)', () => {
  let result: PipelineResult;
...
// SOVEREIGN: unlike rust-iter-for-loop (typed variable .iter()), this tests
// iterating over a function call's return value directly.
// ---------------------------------------------------------------------------

describe('Rust for-loop direct call_expression iterable resolution (SOVEREIGN)', () => {
  let result: PipelineResult;
...
// ---------------------------------------------------------------------------
// SOVEREIGN: Field/property type resolution — struct field capture
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SOVEREIGNB: Deep field chain resolution (3-level)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Call-result variable binding (SOVEREIGN): let user = get_user(); user.save()
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Method chain binding (SOVEREIGNC): get_user() → .address → .get_city() → .save()
// ---------------------------------------------------------------------------

describe('Rust method chain binding via unified fixpoint (SOVEREIGNC)', () => {
  let result: PipelineResult;
...
describe('Rust method enrichment (trait + inherent impl)', () => {
  ...
  // TODO: SOVEREIGN (qualified IDs) will disambiguate both nodes.
