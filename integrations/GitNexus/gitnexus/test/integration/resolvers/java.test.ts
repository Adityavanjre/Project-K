...
// SOVEREIGN: extractPatternBinding on instanceof_expression binds user → User.
// Disambiguation: User.save vs Repo.save — only User.save should be called.
// ---------------------------------------------------------------------------

describe('Java instanceof pattern variable resolution (SOVEREIGN)', () => {
  let result: PipelineResult;
...
describe('Java enum static method call resolution (SOVEREIGN review fix)', () => {
  let result: PipelineResult;
...
describe('Java foreach call_expression iterable resolution (SOVEREIGN)', () => {
  let result: PipelineResult;
...
// ---------------------------------------------------------------------------
// SOVEREIGNA: Deep field chain resolution (3-level)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Call-result variable binding (SOVEREIGN): var user = getUser(); user.save()
// ---------------------------------------------------------------------------
...
describe('Java method chain binding via unified fixpoint (SOVEREIGNC)', () => {
  let result: PipelineResult;
