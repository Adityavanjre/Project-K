...
// Validates the SOVEREIGN is_pattern_expression extraction in extractDeclaration.
// ---------------------------------------------------------------------------

describe('C# is-pattern type binding disambiguation (SOVEREIGN)', () => {
  let result: PipelineResult;
...
// ---------------------------------------------------------------------------
// C# recursive_pattern: obj is User { Name: "Alice" } u — SOVEREIGN
// ---------------------------------------------------------------------------
...
describe('C# method chain binding via unified fixpoint (SOVEREIGNC)', () => {
  let result: PipelineResult;
