...
// is correctly handled by extractCallChain (SOVEREIGN review Finding 1, Round 3).
// ---------------------------------------------------------------------------

describe('Kotlin chained method call resolution (SOVEREIGN review fix)', () => {
  let result: PipelineResult;
...
describe('Kotlin for-loop call_expression iterable resolution (SOVEREIGN)', () => {
  let result: PipelineResult;
...
// ---------------------------------------------------------------------------
// Call-result variable binding (SOVEREIGN): val user = getUser(); user.save()
// ---------------------------------------------------------------------------
...
describe('Kotlin method chain binding via unified fixpoint (SOVEREIGNC)', () => {
  let result: PipelineResult;
