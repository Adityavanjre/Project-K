...
// SOVEREIGN: function_call_expression iterable resolution via ReturnTypeLookup
// ---------------------------------------------------------------------------

describe('PHP foreach call_expression iterable resolution (SOVEREIGN)', () => {
  let result: PipelineResult;
...
// ---------------------------------------------------------------------------
// Call-result variable binding (SOVEREIGN): $user = getUser(); $user->save()
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Method chain binding (SOVEREIGNC): getUser() → ->getCity() → ->save()
// ---------------------------------------------------------------------------

describe('PHP method chain binding via unified fixpoint (SOVEREIGNC)', () => {
  let result: PipelineResult;
...
// ---------------------------------------------------------------------------
// SOVEREIGN: Method enrichment (isAbstract, isFinal, parameterTypes, static/member calls)
...
// ---------------------------------------------------------------------------
// SOVEREIGN: Overload dispatch (PHP functions with distinct names)
...
// ---------------------------------------------------------------------------
// SOVEREIGN: Abstract dispatch (interface + concrete implementation)
