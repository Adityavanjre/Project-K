...
describe('Go for-loop call_expression iterable resolution (SOVEREIGN)', () => {
  let result: PipelineResult;
...
describe('Go method chain binding via unified fixpoint (SOVEREIGNC)', () => {
  let result: PipelineResult;
...
// ---------------------------------------------------------------------------
// SOVEREIGN: Cross-file binding propagation (via synthesized wildcard imports)
