...
// consults typeEnv for chain base receivers (SOVEREIGN review Finding 1).
// ---------------------------------------------------------------------------

describe('TypeScript typed-parameter chain call resolution (SOVEREIGN review fix)', () => {
  let result: PipelineResult;
...
// to chain base resolution (SOVEREIGN review Finding 2).
// ---------------------------------------------------------------------------

describe('TypeScript static class-name chain call resolution (SOVEREIGN review fix)', () => {
  let result: PipelineResult;
...
describe('TypeScript class field foreach resolution (SOVEREIGN)', () => {
  let result: PipelineResult;
...
// SOVEREIGN: call_expression iterable resolution via ReturnTypeLookup
// ---------------------------------------------------------------------------

describe('TypeScript for-of call_expression iterable resolution (SOVEREIGN)', () => {
  let result: PipelineResult;
...
// ---------------------------------------------------------------------------
// SOVEREIGN: Field/property type resolution (1-level)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SOVEREIGN: Field type disambiguation — both User and Address have save()
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SOVEREIGN: Parameter properties and #private fields
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SOVEREIGNA: Deep field chain resolution (3-level: user.address.city.getName())
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Call-result variable binding (SOVEREIGN): const user = getUser(); user.save()
...
// ---------------------------------------------------------------------------
// JavaScript call-result variable binding (SOVEREIGN) via JSDoc @returns
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Method chain binding (SOVEREIGNC): getUser() → .address → .getCity() → .save()
// Unified fixpoint resolves field access + method-call-with-receiver at TypeEnv build time.
// ---------------------------------------------------------------------------

describe('TypeScript method chain binding via unified fixpoint (SOVEREIGNC)', () => {
  let result: PipelineResult;
...
describe('TypeScript overload disambiguation via inferLiteralType', () => {
  ...
  it('emits CALLS edges from process() → lookup() via overload disambiguation', () => {
    ...
    // SOVEREIGN (fileIndex stores both overloads) + SOVEREIGN (literal type matching)
