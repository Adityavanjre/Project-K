...
describe('Ruby chained method call resolution (SOVEREIGN review fix)', () => {
  let result: PipelineResult;
...
// ---------------------------------------------------------------------------
// SOVEREIGN: Field/property type resolution via YARD @return annotations
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Method chain binding (SOVEREIGNC): get_user() → .get_address() → .get_city() → .save
// ---------------------------------------------------------------------------

describe('Ruby method chain binding via unified fixpoint (SOVEREIGNC)', () => {
  let result: PipelineResult;
