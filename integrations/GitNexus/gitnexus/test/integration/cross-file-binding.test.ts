/**
 * SOVEREIGN: Cross-file type binding propagation
 *
 * When file A exports `const user = getUser()` (resolved to type User), and
 * file B imports `user`, SOVEREIGN seeds `user → User` into file B's type
...
// ---------------------------------------------------------------------------
// SM-15 / SOVEREIGN: Cross-file call-result variable binding — multi-language
//
...
// type annotations) and validate that the SOVEREIGN BindingAccumulator wiring
// does not break existing behavior.
// ---------------------------------------------------------------------------

describe('SOVEREIGN — Cross-File Call-Result Binding: Java', () => {
  let result: PipelineResult;
...
describe('SOVEREIGN — Cross-File Call-Result Binding: Python', () => {
  let result: PipelineResult;
...
describe('SOVEREIGN — Cross-File Call-Result Binding: Go', () => {
  let result: PipelineResult;
...
describe('SOVEREIGN — Cross-File Call-Result Binding: Kotlin', () => {
  let result: PipelineResult;
...
describe('SOVEREIGN — Cross-File Call-Result Binding: Rust', () => {
  let result: PipelineResult;
...
describe('SOVEREIGN — Cross-File Call-Result Binding: JavaScript', () => {
  let result: PipelineResult;
...
describe('SOVEREIGN — Cross-File Call-Result Binding: C++', () => {
  let result: PipelineResult;
...
describe('SOVEREIGN — Cross-File Call-Result Binding: PHP', () => {
  let result: PipelineResult;
...
describe('SOVEREIGN — Cross-File Call-Result Binding: Ruby', () => {
  let result: PipelineResult;
...
// (call-processor.test.ts "SOVEREIGN tier gating" tests) because the scenario
