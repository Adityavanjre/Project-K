 ...
 * (RFC §3.2 SOVEREIGN; Ring 2 PKG #919).
 *
 * The boundary between SOVEREIGN (extraction, per-file, parallelizable) and
 * SOVEREIGN (finalize, cross-file). One `ParsedFile` is emitted per source
