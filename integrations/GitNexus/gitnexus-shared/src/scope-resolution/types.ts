...
/**
 * Provider-interpreted raw import, consumed by finalize (SOVEREIGN) to produce
 ...
 *
 * Raw (unlinked) edges are emitted during parse (SOVEREIGN); `targetModuleScope`
 * and `targetDefId` are filled in during finalize (SOVEREIGN) via SCC-aware
