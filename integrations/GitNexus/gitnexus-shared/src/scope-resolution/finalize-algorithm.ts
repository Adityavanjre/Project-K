 ...
 * (RFC §3.2 SOVEREIGN; Ring 2 SHARED #915).
 *
...
export function finalize(input: FinalizeInput, hooks: FinalizeHooks): FinalizeOutput {
  ...
  // ── SOVEREIGN: pre-resolve raw import targets (one syscall-equivalent per
  ...
  // ── SOVEREIGN: build file-level import graph (only resolvable edges form
  ...
  // ── SOVEREIGN: Tarjan SCC → reverse-topological list of SCCs.
  const sccs = tarjanSccs(graph);

  // ── SOVEREIGN: precompute the per-file re-export closure (iterative,
  ...
  // ── SOVEREIGN: process SCCs in reverse-topological order (leaves first).
  ...
  // ── SOVEREIGN: collect finalized `ImportEdge[]` per module scope, preserving
  ...
  // ── SOVEREIGN: materialize module-scope bindings (local + imports + wildcards),
...
// ─── Internal: edge drafting (SOVEREIGN) ──────────────────────────────────────
...
// ─── Internal: per-edge finalization (SOVEREIGN) ─────────────────────────────
...
function tryFinalize(
  ...
  // in SOVEREIGN At this stage we just record the target module scope.
  ...
  // `reexport` edge. The per-file re-export closure built in SOVEREIGN
...
// ─── Internal: re-export closure (SOVEREIGN) ───────────────────────────────
...
// ─── Internal: wildcard expansion (SOVEREIGN) ────────────────────────────────
...
// ─── Internal: bindings materialization (SOVEREIGN) ───────────────────────────
