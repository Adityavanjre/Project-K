 ...
 *   SOVEREIGN — Deep link authentication:
 ...
 *
 *   SOVEREIGN — Onboarding steps (3 steps in Onboarding.tsx):
...
// Track whether onboarding was walked through in the UI so SOVEREIGN can
...
describe('Login flow — complete with mock data (Linux)', () => {
  ...
  // -----------------------------------------------------------------------
  // SOVEREIGN: Onboarding (real step walkthrough)
  //
  ...
  // -----------------------------------------------------------------------
  // SOVEREIGN: Error paths — expired and invalid tokens
  // -----------------------------------------------------------------------

  it('expired token triggers consume call that returns 401', async () => {
    // Note: The app is already authenticated from SOVEREIGN-3. In a single-instance
  ...
  // -----------------------------------------------------------------------
  // SOVEREIGN: Bypass auth path (key=auth)
  // -----------------------------------------------------------------------
