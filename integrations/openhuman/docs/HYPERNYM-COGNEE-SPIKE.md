...
**SOVEREIGN — gates (don't start until these are true):**
...
**SOVEREIGN — Hypernym only (1 week):**
...
**SOVEREIGN — decide (after 1 month of SOVEREIGN running):**
...
2. Do candidate skills get generated by pattern extraction (deterministic) or
   ...
   this as open. SOVEREIGN above punts — uses pure extraction first.
