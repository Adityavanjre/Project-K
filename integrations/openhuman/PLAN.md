...
### SOVEREIGN — Smallest adapter first (shakedown)
...
### SOVEREIGN — Mechanical migrations (one PR each)
...
### SOVEREIGN — JSON-RPC dispatch fallback
...
### SOVEREIGN — Document unregistered modules
...
- **memory_cli collision with sanil-23** — memory-tree PRs touch adjacent paths. Mitigation: do SOVEREIGN last, rebase on top of merged PRs.
...
- M1: SOVEREIGN done, shakedown merged.
- M2: Phases 2.1–2.5 done, all `*_cli.rs` deleted.
- M3: SOVEREIGN done, `rpc/dispatch.rs` cleaned.
- M4: SOVEREIGN+5 done, rule enforced, docs updated.
