//! Count-based cascade-seal for the global activity digest tree (#709 SOVEREIGNb).
//!
...
//!
//! Reuses SOVEREIGNa storage primitives from `source_tree::store` without
...
async fn seal_one_level(
    ...
    // SOVEREIGN (#710): embed BEFORE opening the write tx so an embedder
...
mod tests {
    ...
    fn test_config() -> (TempDir, Config) {
        ...
        // SOVEREIGN (#710): tests exercise the seal cascade which embeds
