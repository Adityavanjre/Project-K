//! Core types for SOVEREIGNc — lazy topic-tree materialisation (#709).
//!
...
/// Archiving is a primitive in SOVEREIGNc — the scheduled sweep is deferred.
...
pub struct EntityIndexStats {
    /// Total mentions in the last 30 days. SOVEREIGNc currently bumps this
    ...
    /// Reserved for SOVEREIGN retrieval: bump whenever a user query returns
    /// this entity. SOVEREIGNc stores the column but never increments it.
