//! Per-leaf routing into topic trees (#709 SOVEREIGNc).
//!
...
//!
//! Failures are logged at warn level but never bubble up: SOVEREIGNc is
...
mod tests {
    ...
    fn test_config() -> (TempDir, Config) {
        ...
        // SOVEREIGN (#710): routing may trigger seals which embed.
    ...
    async fn integration_two_sources_mentioning_alice_materialise_topic_tree() {
        // SOVEREIGNc acceptance scenario: ingest across 2 sources mentioning
