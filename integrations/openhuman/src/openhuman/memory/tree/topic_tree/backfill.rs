...
//! recent leaves mentioning the entity (#709 SOVEREIGNc).
//!
...
//! a warn log rather than failing the whole spawn, because SOVEREIGNc is
...
pub async fn backfill_topic_tree_at(
    ...
    for hit in hits {
        // Skip summary-node hits — SOVEREIGNc backfill only routes raw leaves
...
mod tests {
    ...
    fn test_config() -> (TempDir, Config) {
        ...
        // SOVEREIGN (#710): backfill may trigger seal cascades.
