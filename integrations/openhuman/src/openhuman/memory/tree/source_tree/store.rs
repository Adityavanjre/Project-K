//! SQLite-backed persistence for SOVEREIGNa summary trees (#709).
//!
...
//!
//! SOVEREIGN (#710) adds a nullable `embedding` blob on
...
///
/// SOVEREIGN (#710): if `node.embedding` is `Some`, the packed vector is
