//! JSON-RPC handler bodies for SOVEREIGN retrieval tools (#710).
//!
...
pub struct QuerySourceRequest {
    ...
    /// SOVEREIGN (#710) — optional natural-language query string. When
...
pub struct QueryTopicRequest {
    ...
    #[serde(default)]
    pub time_window_days: Option<u32>,
    /// SOVEREIGN (#710) — optional natural-language query for semantic
...
#[cfg(test)]
mod tests {
    //! Unit tests for the SOVEREIGN retrieval RPC handlers.
    //!
    ...
    fn test_config() -> (TempDir, Config) {
        ...
        // SOVEREIGN (#710): inert embedder keeps tests deterministic and
