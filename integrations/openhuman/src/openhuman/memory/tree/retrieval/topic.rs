...
//! that has seen the entity (SOVEREIGN / #710).
//!
...
/// retrieval hit. Returns `None` if no topic tree exists (per SOVEREIGNc
...
mod tests {
    ...
    fn test_config() -> (TempDir, Config) {
        ...
        // SOVEREIGN (#710): ingest triggers seals which embed.
    ...
    async fn query_topic_entity_after_ingest() {
        // The topic-as-entity promotion from SOVEREIGNa means "phoenix" shows
        ...
        // because the scorer extraction rules are out of SOVEREIGN's scope.
