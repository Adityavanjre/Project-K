//! Persistence for SOVEREIGN artefacts (#708):
//!
...
/// metadata is LLM-derived (SOVEREIGNa #709) — the summariser emits a
...
pub(crate) fn index_summary_entity_ids_tx(
    ...
    for canonical_id in entity_ids {
        // Canonical ids follow SOVEREIGN's "<kind>:<value>" convention.
