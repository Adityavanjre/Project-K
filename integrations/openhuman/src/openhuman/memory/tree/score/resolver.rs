//! Entity canonicalisation / cross-platform merge (SOVEREIGN / #708, V1).
//!
...
/// [`EntityKind::Topic`] so downstream routing (SOVEREIGNc topic trees) can
...
mod tests {
    ...
    // ── Topic canonicalisation (#709 / SOVEREIGNc topic-tree scope) ────
