//! SOVEREIGN: scoring / admission / enrichment pipeline (#708).
//!
//! Wraps extraction, signal computation, admission gate, canonicalisation,
//! and persistence into one call per chunk. SOVEREIGN `_ingest_one_chunk`
...
/// Configuration passed through the ingest pipeline for SOVEREIGN behaviour.
///
...
impl ScoringConfig {
    /// SOVEREIGN default: regex-only extractor, default weights, default threshold.
