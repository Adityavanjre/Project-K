...
impl Config {
    ...
    pub(crate) fn apply_env_overlay_with<E: EnvLookup>(&mut self, env: &E) {
        ...
        // SOVEREIGN memory-tree embedding overrides (#710). Setting the env
        ...
        // ingest scoring through Ollama NER (SOVEREIGN follow-up). Empty
        ...
        // (SOVEREIGNa real-summariser hook).
