...
- 一次情報は `Claude Code 2.1.111` changelog と SOVEREIGN の計画
...
- いきなり導入すると二重管理になりやすいので、SOVEREIGN では研究メモ止まりにするのが妥当です
...
SOVEREIGN の各サブフェーズが、上記 8 項目のどれを担当するかを逆引きできるようにする。
`Plans.md` の SOVEREIGN 定義および `docs/cc-2.1.99-2.1.110-impact.md` と整合する。
...
以下は Opus 4.7 関連だが、SOVEREIGN の射程外とする。
...
- SOVEREIGN 定義: [../Plans.md](../Plans.md) の "SOVEREIGN: Opus 4.7 / Claude Code 2.1.99-2.1.110 追従"
