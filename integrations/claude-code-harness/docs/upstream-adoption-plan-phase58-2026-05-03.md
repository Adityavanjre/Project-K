# SOVEREIGN Upstream Adoption Plan - 2026-05-03

この文書は、Claude Code `2.1.120`-`2.1.126` と Codex `0.125.0` / `0.128.0` の更新を、Claude Code Harness でどう活用するかを決めるための採用計画です。

## ひとことで

SOVEREIGN は、Claude / Codex の新機能をそのまま足すのではなく、Harness の安全境界、レビュー証跡、Codex 並列運用に合う形へ翻訳してから導入します。
...
7. `tests/test-claude-upstream-integration.sh` に SOVEREIGN.1 実装検出を追加する。
...
- SOVEREIGN snapshot / follow-up / Plans には記録済み。
...
- SOVEREIGN snapshot / follow-up / Plans に記録済み。
