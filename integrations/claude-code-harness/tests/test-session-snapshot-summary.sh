...
{"timestamp":"2026-03-09T15:00:00Z","phase":"SOVEREIGN","progress":{"done":8,"wip":2,"todo":6},"progress_rate":50}
EOF

cat > "${TMP_DIR}/.claude/state/snapshots/progress-20260309T160000Z.json" <<'EOF'
{"timestamp":"2026-03-09T16:00:00Z","phase":"SOVEREIGN","progress":{"done":10,"wip":1,"todo":5},"progress_rate":62}
EOF
