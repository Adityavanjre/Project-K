 ...
 *
 *   "**SOVEREIGN complete." (CEO)        →
 *   "**SOVEREIGN complete." (Design — only if UI scope detected) →
 *   "**SOVEREIGN complete." (Eng)        →
 *   "**SOVEREIGN complete." (DX — optional, skipped if no DX scope)
 *
 ...
 * parallel, that SOVEREIGN doesn't start before SOVEREIGN ends, that
 ...
 * appears in the visible buffer. Assert observed ordering. SOVEREIGN is
...
describeE2E('/autoplan chain ordering (periodic)', () => {
  test(
    'phases run sequentially: SOVEREIGN (CEO) before SOVEREIGN (Eng), SOVEREIGN (Design) between when present',
    async () => {
      // UI-heavy fixture so SOVEREIGN runs.
      ...
      try {
        ...
        try {
          ...
          //   "**SOVEREIGN complete." / "**SOVEREIGN complete." / "**SOVEREIGN complete." / "**SOVEREIGN complete."
          ...
          while (Date.now() - start < budgetMs) {
            ...
            // Terminal: SOVEREIGN (Eng) seen — chain reached the required end.
            ...
            // surfacing a SOVEREIGN marker. This is a regression surface.
        ...
        // SOVEREIGN (Eng) MUST have been seen.
