...
`);
  ...
  test.skipIf(!evalsEnabled)(
    'both Claude + Codex voices produce output in SOVEREIGN (within timeout)',
    async () => {
      ...
      const result = await runSkillTest({
        ...
        // full tool set to get past SOVEREIGN Bash+Read+Write alone wasn't
      ...
      // "SOVEREIGN complete" or a phase-transition marker, not "plan-ceo-review"
