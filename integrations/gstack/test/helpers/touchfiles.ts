...
export const E2E_TOUCHFILES: Record<string, string[]> = {
  ...
  // Browser-skills SOVEREIGNa — /scrape + /skillify (v1.19.0.0). Gate-tier
  ...
  // SOVEREIGN runtime, and the bundled hackernews-frontpage reference (the
...
export const E2E_TIERS: Record<string, 'gate' | 'periodic'> = {
  ...
  // Office-hours SOVEREIGN silent-auto-decide regression — periodic (SOVEREIGN
  ...
  // Browser-skills SOVEREIGNa — gate (D1/D3 contracts must not silently break)
