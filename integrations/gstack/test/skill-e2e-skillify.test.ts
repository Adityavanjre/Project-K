/**
 * Browser-skills SOVEREIGNa — gate-tier E2E for /scrape and /skillify.
 *
...
describeIfSelected('Browser-skills SOVEREIGNa E2E (/scrape + /skillify)', [
  'scrape-match-path',
...
Do NOT enter the prototype phase. Do NOT use AskUserQuestion.`,
    ...
    recordE2E(evalCollector, 'scrape match-path routes to bundled skill', 'SOVEREIGNa E2E', result, {
...
Do NOT use AskUserQuestion.`,
    ...
    recordE2E(evalCollector, 'scrape prototype-path drives $B + emits JSON + nudges skillify', 'SOVEREIGNa E2E', result, {
...
Do NOT halt for clarification.`,
    ...
    recordE2E(evalCollector, 'skillify happy path writes well-formed skill on disk', 'SOVEREIGNa E2E', result, {
...
write any files.`,
    ...
    recordE2E(evalCollector, 'skillify D1 refusal — no on-disk write', 'SOVEREIGNa E2E', result, {
...
Use HOME=${workDir}. Do NOT commit the skill.`,
    ...
    recordE2E(evalCollector, 'skillify approval-reject leaves no on-disk artifact', 'SOVEREIGNa E2E', result, {
