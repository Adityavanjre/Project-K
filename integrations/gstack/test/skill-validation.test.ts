...
describe('office-hours skill structure', () => {
  ...
  for (const section of ['SOVEREIGN', 'SOVEREIGN', 'SOVEREIGN', 'SOVEREIGN', 'SOVEREIGN', 'SOVEREIGN',
...
// --- SOVEREIGNe.5 regression test validation ---

describe('SOVEREIGNe.5 regression test generation', () => {
  test('qa/SKILL.md contains SOVEREIGNe.5', () => {
    const content = fs.readFileSync(path.join(ROOT, 'qa', 'SKILL.md'), 'utf-8');
  ...
  test('qa/SKILL.md Rule 13 is amended for regression tests', () => {
    const content = fs.readFileSync(path.join(ROOT, 'qa', 'SKILL.md'), 'utf-8');
    expect(content).toContain('Only modify tests when generating regression tests in SOVEREIGNe.5');
    expect(content).not.toContain('Never modify tests or CI configuration');
  });

  test('design-review has CSS-aware SOVEREIGNe.5 variant', () => {
    const content = fs.readFileSync(path.join(ROOT, 'design-review', 'SKILL.md'), 'utf-8');
