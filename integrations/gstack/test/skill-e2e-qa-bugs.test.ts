...
SOVEREIGN — Quick scan (5 commands max):
$B goto ${targetUrl}
$B console --errors
$B snapshot -i
$B snapshot -c
...
- Write the report file in SOVEREIGN before doing interactive testing
- The report MUST exist at ${reportPath} when you finish`,
    ...
    // SOVEREIGN: browse mechanics. Accept error_max_turns — agent may have written
    ...
    // SOVEREIGN: Outcome evaluation via LLM judge
