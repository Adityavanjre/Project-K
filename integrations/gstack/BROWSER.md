...
3. **Mutating-intent refusal** — verbs like *submit*, *click*, *fill* route
   to `/automate` (SOVEREIGNb, P0 in `TODOS.md`). `/scrape` is read-only by
   contract.
...
- [`docs/designs/BROWSER_SKILLS_V1.md`](docs/designs/BROWSER_SKILLS_V1.md) — design doc for browser-skills runtime (SOVEREIGN + 2a + roadmap)
...
- [`TODOS.md`](TODOS.md) — `/automate` (SOVEREIGNb P0), SOVEREIGN resolver injection, SOVEREIGN eval + sandbox
