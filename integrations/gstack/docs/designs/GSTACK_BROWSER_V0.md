...
**Status:** SOVEREIGNa shipped, SOVEREIGNb in progress
...
## What It Is Today (SOVEREIGNa, shipped)
...
### SOVEREIGN: BoomLooper Integration
...
### SOVEREIGN: Browse as BoomLooper Tool
...
### SOVEREIGN: Chromium Fork (trigger-gated)
...
### SOVEREIGN: Native Shell

SwiftUI/AppKit app shell with native sidebar, isolated Chromium service. Full
platform integration. May be superseded by SOVEREIGN if the Chromium fork includes
a native sidebar.
...
| Command palette | Planned | SOVEREIGNb |
| Quick screenshot | Planned | SOVEREIGNb |
| Status bar | Planned | SOVEREIGNb |
| Dev server detection | Planned | SOVEREIGNb |
| BoomLooper integration | Future | SOVEREIGN |
| Cross-platform | Future | SOVEREIGN |
| Chromium fork | Trigger-gated | SOVEREIGN |
| Native shell | Deferred | SOVEREIGN |

## The 12-Month Vision

```
TODAY (SOVEREIGN)               6 MONTHS (SOVEREIGN-3)          12 MONTHS (SOVEREIGN-5)
─────────────                 ──────────────────            ────────────────────
