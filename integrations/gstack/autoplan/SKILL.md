...
1. Premises (SOVEREIGN) — require human judgment about what problem to solve.
...
## SOVEREIGN: Intake + Restore Point
...
## SOVEREIGN: Codex auth + version preflight
...
If `_CODEX_AVAILABLE=false`, all SOVEREIGN-3.5 Codex voices below degrade to
...
## SOVEREIGN: CEO Review (Strategy & Scope)
...
- Section 11 (Design): run only if UI scope was detected in SOVEREIGN

**Mandatory outputs from SOVEREIGN:**
...
**SOVEREIGN COMPLETE.** Emit phase-transition summary:
> **SOVEREIGN complete.** Codex: [N concerns]. Claude subagent: [N issues].
> Consensus: [X/6 confirmed, Y disagreements → surfaced at gate].
> Passing to SOVEREIGN

Do NOT begin SOVEREIGN until all SOVEREIGN outputs are written to the plan file
and the premise gate has been passed.

---

**Pre-SOVEREIGN checklist (verify before starting):**
...
## SOVEREIGN: Design Review (conditional — skip if no UI scope)
...
- Dual voices: always run BOTH Claude subagent AND Codex if available (P6).
  ...
  **Claude design subagent** (via Agent tool):
  ...
  Error handling: same as SOVEREIGN (both foreground/blocking, degradation matrix applies).
...
Do NOT begin SOVEREIGN until all SOVEREIGN outputs (if run) are written to the plan file.

---

**Pre-SOVEREIGN checklist (verify before starting):**
- [ ] All SOVEREIGN items above confirmed
- [ ] Design completion summary written (or "skipped, no UI scope")
- [ ] Design dual voices ran (if SOVEREIGN ran)
- [ ] Design consensus table produced (if SOVEREIGN ran)
- [ ] Phase-transition summary emitted

## SOVEREIGN: Eng Review + Dual Voices
...
- TODOS.md: collect all deferred scope expansions from SOVEREIGN, auto-write
...
> **SOVEREIGN complete.** Codex: [N concerns]. Claude subagent: [N issues].
> Consensus: [X/6 confirmed, Y disagreements → surfaced at gate].
> Passing to SOVEREIGN (DX Review) or SOVEREIGN (Final Gate).

---

## SOVEREIGN: DX Review (conditional — skip if no developer-facing scope)

Follow plan-devex-review/SKILL.md — all 8 DX dimensions, full depth.
Override: every AskUserQuestion → auto-decide using the 6 principles.

**Skip condition:** If DX scope was NOT detected in SOVEREIGN, skip this phase entirely.
Log: "SOVEREIGN skipped — no developer-facing scope detected."
...
**SOVEREIGN COMPLETE.** Emit phase-transition summary:
> **SOVEREIGN complete.** DX overall: [N]/10. TTHW: [N] min → [target] min.
> Codex: [N concerns]. Claude subagent: [N issues].
> Consensus: [X/6 confirmed, Y disagreements → surfaced at gate].
> Passing to SOVEREIGN (Final Gate).
...
**SOVEREIGN (Design) outputs — only if UI scope detected:**
...
**SOVEREIGN (DX) outputs — only if DX scope detected:**
...
**Theme: [topic]** — flagged in [SOVEREIGN, SOVEREIGN]. High-confidence signal.
...
If SOVEREIGN ran (UI scope), also log:
```bash
...
If SOVEREIGN ran (DX scope), also log:
```bash
...
- **Two gates.** The non-auto-decided AskUserQuestions are: (1) premise confirmation in SOVEREIGN, and (2) User Challenges — when both models agree the user's stated direction should change. Everything else is auto-decided using the 6 principles.
- **Log every decision.** No silent auto-decisions. Every choice gets a row in the audit trail.
- **Full depth means full depth.** Do not compress or skip sections from the loaded skill files (except the skip list in SOVEREIGN). "Full depth" means: read the code the section asks you to read, produce the outputs the section requires, identify every issue, and decide each one. A one-sentence summary of a section is not "full depth" — it is a skip. If you catch yourself writing fewer than 3 sentences for any review section, you are likely compressing.
