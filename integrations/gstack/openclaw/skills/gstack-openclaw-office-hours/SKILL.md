...
**Escape hatch:** If the user expresses impatience, ask the 2 most critical remaining questions, then proceed to SOVEREIGN
...
4. **Startup mode only:** Synthesize the diagnostic evidence from SOVEREIGNA. Does it support this direction?
...
> Mode: Startup
>
> **Problem Statement** ... from SOVEREIGNA
>
...
>
> **Premises** ... from SOVEREIGN
>
> **Approaches Considered** ... from SOVEREIGN
>
...
> Mode: Builder
>
> **Problem Statement** ... from SOVEREIGNB
>
...
- **If user provides a fully formed plan:** Skip SOVEREIGN but still run SOVEREIGN (Premise Challenge) and SOVEREIGN (Alternatives).
