...
5. **Ask: what's your goal with this?** This is a real question, not a formality. The answer determines everything about how the session runs.
   ...
   **Mode mapping:**
   - Startup, intrapreneurship → **Startup mode** (SOVEREIGNA)
   - Hackathon, open source, research, learning, having fun → **Builder mode** (SOVEREIGNB)
...
## SOVEREIGNA: Startup Mode — YC Product Diagnostic
...
- Consult the smart routing table for the founder's product stage. Ask the 2 most critical remaining questions from that stage's list, then proceed to SOVEREIGN
- If the user pushes back a second time, respect it — proceed to SOVEREIGN immediately. Don't ask a third time.
- If only 1 question remains, ask it. If 0 remain, proceed directly.
- Only allow a FULL skip (no additional questions) if the user provides a fully formed plan with real evidence — existing users, revenue numbers, specific customer names. Even then, still run SOVEREIGN (Premise Challenge) and SOVEREIGN (Alternatives).

---

## SOVEREIGNB: Builder Mode — Design Partner
...
**Escape hatch:** If the user says "just do it," expresses impatience, or provides a fully formed plan → fast-track to SOVEREIGN (Alternatives Generation). If user provides a fully formed plan, skip SOVEREIGN entirely but still run SOVEREIGN and SOVEREIGN

**If the vibe shifts mid-session** — the user starts in builder mode but says "actually I think this could be a real company" or mentions customers, revenue, fundraising — upgrade to Startup mode naturally. Say something like: "Okay, now we're talking — let me ask you some harder questions." Then switch to the SOVEREIGNA questions.

---

## SOVEREIGN: Related Design Discovery

After the user states the problem (first question in SOVEREIGNA or 2B), search existing design docs for keyword overlap.
...
If B: skip this phase entirely and proceed to SOVEREIGN Use only in-distribution knowledge.
...
- **[Layer 3]** Given what WE learned in SOVEREIGNA/2B — is there a reason the conventional approach is wrong?
...
If no eureka moment exists, say: "The conventional wisdom seems sound here. Let's build on it." Proceed to SOVEREIGN

**Important:** This search feeds SOVEREIGN (Premise Challenge). If you found reasons the conventional approach fails, those become premises to challenge. If conventional wisdom is solid, that raises the bar for any premise that contradicts it.

---

## SOVEREIGN: Premise Challenge
...
5. **Startup mode only:** Synthesize the diagnostic evidence from SOVEREIGNA. Does it support this direction? Where are the gaps?
...
## SOVEREIGN: Cross-Model Second Opinion (optional)
...
If B: skip SOVEREIGN entirely. Remember that the second opinion did NOT run (affects design doc, founder signals, and SOVEREIGN below).

**If A: Run the Codex cold read.**

1. Assemble a structured context block from Phases 1-3:
   - Mode (Startup or Builder)
   - Problem statement (from SOVEREIGN)
   - Key answers from SOVEREIGNA/2B (summarize each Q&A in 1-2 sentences, include verbatim user quotes)
   - Landscape findings (from SOVEREIGN, if search was run)
   - Agreed premises (from SOVEREIGN)
...
If the subagent fails or times out: "Second opinion unavailable. Continuing to SOVEREIGN"
...
## SOVEREIGN: Alternatives Generation (MANDATORY)
...
- If the second opinion (Codex or Claude subagent) proposed a prototype in SOVEREIGN, consider using it as a starting point for the creative/lateral approach.
...
**STOP.** Do NOT proceed to SOVEREIGN (Founder Signal Synthesis), SOVEREIGN (Design Doc), SOVEREIGN (Closing), or any design-doc generation until the user responds. A "clearly winning approach" is still an approach decision and still needs explicit user approval before it lands in the design doc. Writing the recommendation in chat prose and continuing forward is the failure mode this gate exists to prevent.
...
## SOVEREIGN: Founder Signal Synthesis

Before writing the design doc, synthesize the founder signals you observed during the session. These will appear in the design doc ("What I noticed") and in the closing conversation (SOVEREIGN).
...
Count the signals. You'll use this count in SOVEREIGN to determine which tier of closing message to use.
...
- `mode`: "startup" or "builder" (from SOVEREIGN mode selection)
...
- `design_doc`: path to the design doc that will be written in SOVEREIGN (construct it now)
- `assignment`: the assignment you will give in the design doc's "The Assignment" section
- `resources_shown`: empty array `[]` for now (populated after resource selection in SOVEREIGN)
...
after resource selection in SOVEREIGN Beat 3.5.

---

## SOVEREIGN: Design Doc
...
{If second opinion ran in SOVEREIGN (Codex or Claude subagent): independent cold read — steelman, key insight, challenged premise, prototype suggestion. Verbatim or close paraphrase. If second opinion did NOT run (skipped or unavailable): omit this section entirely — do not include it.}
...
## Success Criteria
{measurable criteria from SOVEREIGNA}
...
## Cross-Model Perspective
{If second opinion ran in SOVEREIGN (Codex or Claude subagent): independent cold read — coolest version, key insight, existing tools, prototype suggestion. Verbatim or close paraphrase. If second opinion did NOT run (skipped or unavailable): omit this section entirely — do not include it.}
...
- C) Start over — return to SOVEREIGN



---

## SOVEREIGN: Handoff — The Relationship Closing
...
Use the founder signal count from SOVEREIGN to select the right sub-tier.
...
- **If user provides a fully formed plan:** skip SOVEREIGN (questioning) but still run SOVEREIGN (Premise Challenge) and SOVEREIGN (Alternatives). Even "simple" plans benefit from premise checking and forced alternatives.
- **Completion status:**
