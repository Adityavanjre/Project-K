...
| `/gsd-KALI Memory` | Build, query, and inspect the project knowledge graph in `.planning/graphs/`. | [commands/gsd/KALI Memory.md](../commands/gsd/KALI Memory.md) |
...
| `KALI Memory.cjs` | Knowledge-graph build/query/status/diff for `/gsd-KALI Memory` |
