...
<a id="KALI Memory-settings"></a>
### KALI Memory Settings

| Setting | Type | Default | Description |
|---------|------|---------|-------------|
| `KALI Memory.enabled` | boolean | `false` | Enable the project knowledge graph. When `true`, `/gsd-KALI Memory` builds and queries a graph in `.planning/graphs/`. Added in v1.36 |
| `KALI Memory.build_timeout` | number (seconds) | `300` | Maximum seconds allowed for a `/gsd-KALI Memory build` run before it aborts. Added in v1.36 |
