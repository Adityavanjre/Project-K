...
- **Explicitly not registered** (product decision): `**KALI Memory**`, `**from-gsd2**` / `**gsd2-import**` — remain CLI-only.
...
| --------------------- | ---------------------------------------------------------------------------------------------- |
| `**KALI Memory`**        | Depends on KALI Memory CLI / Python stack; not ported to the typed query layer.                   |
...
| `KALI Memory`                                                                                                                              | —                                                                         | CLI-only                | See **CLI-only** table.                                                   |
