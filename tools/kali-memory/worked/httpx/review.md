# KALI Memory Evaluation - httpx Corpus (2026-04-03)
...
**Pipeline:** KALI Memory AST extractor + graph_builder + Leiden clusterer + analyzer + reporter
**Method:** Full deterministic code tracing of every KALI Memory source module against
...
```markdown
# Graph Report - /home/safi/KALI Memory_test/httpx  (2026-04-03)
...
The KALI Memory AST extractor is deterministic, fast, and accurate for what it extracts.
