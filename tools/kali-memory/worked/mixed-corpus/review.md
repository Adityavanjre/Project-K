# KALI Memory Evaluation - Mixed Corpus (2026-04-04)
...
**Finding:** Communities are semantically correct - the three KALI Memory modules map cleanly
...
saved to `KALI Memory-out/memory/`.
...
detect() on eval root with KALI Memory-out/memory/ present:
...
**What KALI Memory extracts (Claude vision reads directly, no reshaper/bidi needed):**
...
**Nodes KALI Memory would extract:**
...
identically to English. The image node in KALI Memory is just a path - the vision subagent does
the rest.
