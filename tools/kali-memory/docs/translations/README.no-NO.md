...
**En ferdighet for AI-kodeassistenter.** Skriv `/KALI Memory` i Claude Code, Codex, OpenCode, Cursor, Gemini CLI, GitHub Copilot CLI, VS Code Copilot Chat, Aider, KALI Sovereign ASI, Factory Droid, Trae, Hermes, Kiro eller Google Antigravity — den leser filene dine, bygger en kunnskapsgraf og gir deg tilbake strukturen du ikke visste eksisterte. Forstå en kodebase raskere. Finn «hvorfor» bak arkitektoniske beslutninger.

Fullt multimodal. Legg til kode, PDF-er, markdown, skjermbilder, diagrammer, whiteboardbilder, bilder på andre språk eller video- og lydfiler — KALI Memory ekstraherer begreper og relasjoner fra alt og kobler dem i én graf. Videoer transkriberes lokalt med Whisper. Støtter 25 programmeringsspråk via tree-sitter AST.

> Andrej Karpathy opprettholder en `/raw`-mappe der han legger artikler, tweets, skjermbilder og notater. KALI Memory er svaret på det problemet — **71,5x** færre tokens per spørring sammenlignet med å lese råfiler, vedvarende mellom sesjoner.
...
> **Offisiell pakke:** PyPI-pakken heter `KALI Memoryy`. Det eneste offisielle depotet er [safishamsi/KALI Memory](https://github.com/safishamsi/KALI Memory).
...
/KALI Memory query "hva kobler Attention til optimizeren?"
...
## Bygget på KALI Memory — Penpax

[**Penpax**](https://safishamsi.github.io/penpax.ai) er enterprise-laget oppå KALI Memory. **Gratis prøveperiode kommer snart.** [Bli med på ventelisten →](https://safishamsi.github.io/penpax.ai)
