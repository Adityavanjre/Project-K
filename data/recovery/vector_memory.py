...
# 🔱 SILENCE THE NOISE: Force transformers to stay quiet
import logging
import warnings
    ...
    def embedder(self):
        ...
        if self._embedder is None:
            try:
                ...
                # SOVEREIGN: Force local-only loading to prevent external API calls
                self._embedder = SentenceTransformer(self.model_name, trust_remote_code=True, local_files_only=True)
