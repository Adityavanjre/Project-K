...
class KnowledgeBase:
    ...
    def _load_basic_knowledge(self) -> None:
        ...
        basic_knowledge = [
            ...
            KnowledgeItem(
                ...
                domain="technology",
                keywords=["machine", "learning", "algorithms", "data", "patterns", "supervised", "unsupervised"]
            ),
            KnowledgeItem(
                ...
                domain="science",
                keywords=["photosynthesis", "plants", "light", "energy", "glucose", "oxygen", "chloroplast"]
            ),
            KnowledgeItem(
                ...
                domain="mathematics",
                keywords=["pythagorean", "theorem", "triangle", "right", "hypotenuse", "geometry", "square"]
            ),
            KnowledgeItem(
                ...
                domain="history",
                keywords=["democracy", "government", "people", "elected", "representatives", "voting", "rights"]
            )
        ]
    ...
    def _calculate_relevance_score(self, query_words: set, item: KnowledgeItem) -> float:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "domain_breakdown": {domain: len(items) for domain, items in self.domain_index.items()}
        }
