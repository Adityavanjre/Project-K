...
class DoubtProcessor:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        # 6. Telegram Listener Bridge (MUST BE INITIALIZED AFTER PYTORCH TO PREVENT CRASHES)
    ...
    def _background_initialization(self):
        ...
        return # SOVEREIGN FIX: PyTorch init during Flask boot causes Windows native crash
