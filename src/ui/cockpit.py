...
class SovereignCockpit:
    ...
    def _setup_layout(self):
        """Initializes the multi-pane dashboard layout."""
        self.layout.split(
    ...
    def update(self, current_input: str = ""):
        ...
        self.layout["swarm"].update(self._get_swarm_panel())
        self.layout["bio"].update(self._get_bio_panel())
