...
payload = {
    "project_name": "Safe High Power",
    "project_description": "I want to control a 12V DC Motor using an Arduino and an L298N Motor Driver. I will power the driver with a 12V battery and the Arduino via USB."
}

try:
    print(f"Submitting VALID High Voltage Idea: '{payload['project_description']}'...")
    start = time.time()
